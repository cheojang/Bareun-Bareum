...
// 한글 자모 테이블 (export — korean-phonetics.ts 등 공유)
export const CHOSEONG = [
  'ㄱ', 'ㄲ', 'ㄴ', 'ㄷ', 'ㄸ', 'ㄹ', 'ㅁ', 'ㅂ', 'ㅃ',
  'ㅅ', 'ㅆ', 'ㅇ', 'ㅈ', 'ㅉ', 'ㅊ', 'ㅋ', 'ㅌ', 'ㅍ', 'ㅎ'
];

// 표준 21개 중성 (U+314F–U+3163)
// 이전 버전에서 index 12(ㅛ), 13(ㅜ), 17(ㅠ), 18(ㅡ), 20(ㅣ) 누락 버그 수정
export const JUNGSEONG = [
  'ㅏ', 'ㅐ', 'ㅑ', 'ㅒ', 'ㅓ', 'ㅔ', 'ㅕ', 'ㅖ', 'ㅗ', 'ㅘ',
  'ㅙ', 'ㅚ', 'ㅛ', 'ㅜ', 'ㅝ', 'ㅞ', 'ㅟ', 'ㅠ', 'ㅡ', 'ㅢ', 'ㅣ'
];

// 표준 27개 종성 + 빈 종성 (U+11A8–U+11C2 대응, 총 28)
// 이전 버전에서 존재할 수 없는 'ㅉ'이 index 23에 끼어 ㅊ·ㅋ·ㅌ·ㅍ·ㅎ 받침이
// 한 칸씩 밀려 분석되던 버그 수정 (예: 꽃→ㅉ, 밭→ㅋ, 짚→ㅌ 으로 오인)
