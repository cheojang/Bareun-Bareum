...
export const WORD_DATABASE: PracticeWord[] = [
  ...
  { word: "피아노", targetPhonemes: ["ㅍ"], difficulty: "easy",   ageGroup: "4-5세", sampleSentence: "피아노를 쳐요.",            soundEffect: "도레미~" },
  ...
  { word: "오빠", targetPhonemes: ["ㅂ"], difficulty: "easy",   ageGroup: "2-3세", sampleSentence: "오빠가 멋져요." },
  ...
  { word: "우유", targetPhonemes: ["ㅇ"], difficulty: "easy",   ageGroup: "2-3세", sampleSentence: "우유를 마셔요.",            soundEffect: "꿀꺽~" },
  { word: "과자", targetPhonemes: ["ㄱ", "ㅈ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "과자가 바삭바삭해요.",  soundEffect: "바삭~" },
  { word: "사탕수수", targetPhonemes: ["ㅅ"], difficulty: "easy",   ageGroup: "3-4세", sampleSentence: "사탕이 달아요.",            soundEffect: "냠냠~" },
  ...
  { word: "어깨", targetPhonemes: ["ㅇ, ㄲ"], difficulty: "medium", ageGroup: "4-5세", sampleSentence: "어깨가 아파요." },
  ...
  { word: "스웨터", targetPhonemes: ["ㅅ, ㅇ, ㅌ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "스웨터가 따뜻해요." },
  ...
  { word: "울다", targetPhonemes: ["ㅇ", "ㄹ", "ㄷ"], difficulty: "easy", ageGroup: "3-4세", sampleSentence: "슬파서 울어요." },
  ...
  // 형용사 (특성)
  // ══════════════════════════════════════════════════════════
  { word: "크다", targetPhonemes: ["ㄲ", "ㄷ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "상자가 커요." },
  ...
  { word: "좁다", targetPhonemes: ["ㅈ, ㅇ, ㅂ, ㄷ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "방이 좁아요." },
  ...
  { word: "밝다", targetPhonemes: ["ㅂ, ㅂ, ㄷ"], difficulty: "easy", ageGroup: "3-4세", sampleSentence: "햇빛이 밝아요." },
  { word: "어둡다", targetPhonemes: ["ㅇ, ㄷ, ㅂ, ㄷ"], difficulty: "medium", ageGroup: "4-5세", sampleSentence: "밤이 어두워요." },
  { word: "깨끗하다", targetPhonemes: ["ㄲ, ㄷ, ㅎ, ㄷ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "손을 깨끗이 씻어요." },
  ...
  { word: "짠맛", targetPhonemes: ["ㅆ, ㅁ"], difficulty: "medium", ageGroup: "4-5세", sampleSentence: "짠맛이 난다." },

  // ══════════════════════════════════════════════════════════
  // 마지막 추가 카테고리 (교실, 학용품, 기타)
  // ══════════════════════════════════════════════════════════
  { word: "책상", targetPhonemes: ["ㄲ, ㅅ"], difficulty: "medium", ageGroup: "4-5세", sampleSentence: "책상에 책을 놓아요." },
  { word: "의자", targetPhonemes: ["ㅇ, ㅈ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "의자에 앉아요." },
  { word: "칠판", targetPhonemes: ["ㅊ, ㅂ"], difficulty: "medium", ageGroup: "4-5세", sampleSentence: "칠판에 글씨를 써요." },
  { word: "지우개", targetPhonemes: ["ㅈ, ㅇ, ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "지우개로 지워요." },
  ...
  { word: "교실", targetPhonemes: ["ㄱ, ㅇ, ㅅ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "교실에서 공부해요." },
  { word: "운동장", targetPhonemes: ["ㅇ, ㄷ, ㅇ, ㄴ, ㄷ, ㅈ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "운동장에서 달려요." },
  ...
  // 색깔 (Colors)
  { word: "빨강", targetPhonemes: ["ㅂ, ㄹ", "ㅇ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "이건 빨강이에요." },
  { word: "파랑", targetPhonemes: ["ㅍ, ㄹ", "ㅇ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "파랑은 하늘색이에요." },
  { word: "노랑", targetPhonemes: ["ㄴ, ㄹ", "ㅇ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "해는 노랑이에요." },
  ...
  { word: "분홍", targetPhonemes: ["ㅂ, ㄴ, ㅎ, ㅇ"], difficulty: "easy", ageGroup: "3-4세", sampleSentence: "분홍은 예뻐요." },
  { word: "회색", targetPhonemes: ["ㅎ, ㅇ, ㅈ, ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "생쥐는 회색이에요." },
  { word: "검정", targetPhonemes: ["ㄱ, ㅁ, ㅈ, ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "검정색은 어두워요." },
  { word: "하양", targetPhonemes: ["ㅎ, ㅇ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "눈은 하얗고 차가워요." },
  { word: "주황", targetPhonemes: ["ㅊ, ㅎ, ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "귤은 주황색이에요." },

  // 숫자 (Numbers)
  { word: "하나", targetPhonemes: ["ㅎ, ㄴ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "하나, 둘, 셋." },
  { word: "둘", targetPhonemes: ["ㄷ, ㄹ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "사과 둘." },
  { word: "셋", targetPhonemes: ["ㅅ, ㅅ"], difficulty: "medium", ageGroup: "2-3세", sampleSentence: "셋이에요." },
  { word: "넷", targetPhonemes: ["ㄴ, ㅅ"], difficulty: "medium", ageGroup: "2-3세", sampleSentence: "넷까지 세어요." },
  { word: "다섯", targetPhonemes: ["ㄷ, ㅅ, ㅅ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "손가락이 다섯 개예요." },
  { word: "여섯", targetPhonemes: ["ㅇ, ㅅ, ㅅ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "여섯 살이에요." },
  { word: "일곱", targetPhonemes: ["ㅇ, ㄱ, ㅂ"], difficulty: "hard", ageGroup: "3-4세", sampleSentence: "일곱이 되었어요." },
  { word: "여덟", targetPhonemes: ["ㅇ, ㄷ, ㅂ"], difficulty: "hard", ageGroup: "3-4세", sampleSentence: "여덟 개가 있어요." },
  { word: "아홉", targetPhonemes: ["ㅇ, ㅎ, ㅂ"], difficulty: "hard", ageGroup: "3-4세", sampleSentence: "아홉 개를 샀어요." },
  { word: "열", targetPhonemes: ["ㅇ, ㄹ"], difficulty: "easy", ageGroup: "3-4세", sampleSentence: "열 개가 있어요." },

  // 날씨 (Weather)
  { word: "날씨", targetPhonemes: ["ㄴ, ㅅ, ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "오늘 날씨가 좋아요." },
  { word: "맑음", targetPhonemes: ["ㅁ, ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "하늘이 맑아요." },
  { word: "흐림", targetPhonemes: ["ㅎ, ㅇ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "오늘은 흐려요." },
  ...
  { word: "비행기", targetPhonemes: ["ㅂ, ㅎ, ㅇ, ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "비행기를 타고 갔어요." },
  { word: "배", targetPhonemes: ["ㅂ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "배를 타요." },
  { word: "자동차", targetPhonemes: ["ㅊ, ㄷ, ㅊ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "자동차가 빨리 가요." },
  { word: "오토바이", targetPhonemes: ["ㅇ, ㅌ, ㅂ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "오토바이는 시끄러워요." },
  { word: "자전거", targetPhonemes: ["ㅊ, ㅇ, ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "자전거를 타요." },
  ...
  { word: "참외", targetPhonemes: ["ㅊ, ㅇ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "참외가 맛있어요." },
  { word: "복숭아", targetPhonemes: ["ㅂ, ㅅ, ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "복숭아는 부드러워요." },
  ...
  { word: "옥수수", targetPhonemes: ["ㅇ, ㅆ, ㅆ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "옥수수를 먹어요." },
  { word: "감자", targetPhonemes: ["ㄱ, ㅊ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "감자로 밥을 해요." },
  { word: "고구마", targetPhonemes: ["ㄱ, ㄱ, ㅁ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "고구마는 달아요." },
  { word: "양파", targetPhonemes: ["ㅇ, ㅍ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "양파를 잘라요." },
  ...
  { word: "토마토", targetPhonemes: ["ㅌ, ㅁ, ㅌ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "토마토는 빨가요." },
  ...
  // 장난감 (Toys)
  { word: "인형", targetPhonemes: ["ㅇ, ㅎ, ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "인형이 이래요." },
  ...
  { word: "여름방학", targetPhonemes: ["ㅇ, ㅁ, ㅂ, ㅎ, ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "여름방학이에요." },
  ...
  { word: "정월", targetPhonemes: ["ㅈ, ㅇ, ㅇ", "ㄹ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "정월이에요." },
  ...
  // 학용품 (School Supplies)
  { word: "연필", targetPhonemes: ["ㅇ, ㅂ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "연필로 쓰요." },
  ...
  { word: "깎지", targetPhonemes: ["ㄲ, ㅊ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "깎지로 깎아요." },
  ...
  { word: "거울", targetPhonemes: ["ㄱ, ㅇ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "거울에 비어요." },
  ...
  { word: "안녕", targetPhonemes: ["ㅇ, ㄴ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "안녕!" },
  ...
  { word: "좋아", targetPhonemes: ["ㅊ, ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "너 좋아!" },
  ...
  { word: "어제", targetPhonemes: ["ㅇ, ㅊ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "어제는 놀았어요." },
  { word: "오늘", targetPhonemes: ["ㅇ, ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "오늘은 신날 것 같아요." },
  ...
  { word: "아래", targetPhonemes: ["ㅇ, ㄹ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "아래를 봐요." },
  { word: "앞", targetPhonemes: ["ㅇ, ㅍ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "앞으로 가요." },
  { word: "뒤", targetPhonemes: ["ㄷ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "뒤로 와요." },
  { word: "옆", targetPhonemes: ["ㅇ, ㅂ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "옆에 앉아요." },
  { word: "안", targetPhonemes: ["ㅇ, ㄴ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "안에 있어요." },
  { word: "밖", targetPhonemes: ["ㅂ, ㄲ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "밖으로 나가요." },
  { word: "오른쪽", targetPhonemes: ["ㅇ, ㄹ, ㅈ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "오른쪽을 봐요." },
  { word: "왼쪽", targetPhonemes: ["ㅇ, ㄴ, ㅈ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "왼쪽으로 가요." },
  { word: "중간", targetPhonemes: ["ㅊ, ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "중간에 있어요." },
  ...
  { word: "상자", targetPhonemes: ["ㅅ, ㅊ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "상자 안에 있어요." },
  ...
  { word: "생일", targetPhonemes: ["ㅅ, ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "생일은 언제예요?" },
  ...
  { word: "축제", targetPhonemes: ["ㅊ, ㅊ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "축제에서 놀아요." },
  { word: "졸업", targetPhonemes: ["ㅊ, ㅇ, ㅂ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "졸업식이 있어요." },
  { word: "운동회", targetPhonemes: ["ㅇ, ㄷ, ㅇ, ㄴ, ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "운동회가 재미있어요." },
  { word: "발표", targetPhonemes: ["ㅂ, ㅍ, ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "발표를 했어요." },
  { word: "경쟁", targetPhonemes: ["ㄱ, ㅊ, ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "경쟁에서 이겼어요." },
  { word: "게임", targetPhonemes: ["ㄱ, ㅇ, ㅁ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "게임을 할래?" },
];
