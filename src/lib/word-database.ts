...
export const WORD_DATABASE: PracticeWord[] = [
  ...
  // ── 동물 심화 (Animals) ───────────────────────────────────────────────────
  { word: "기린", targetPhonemes: ["ㄱ", "ㄹ", "ㄴ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "기린 목이 길어요." },
  { word: "코끼리", targetPhonemes: ["ㄱ", "ㄲ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "코끼리가 물을 뿌려요.", soundEffect: "뿌우" },
  { word: "악어", targetPhonemes: ["ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "악어 입이 커요." },
  { word: "캥거루", targetPhonemes: ["ㄱ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "캥거루가 뛰어요." },
  { word: "독수리", targetPhonemes: ["ㄷ", "ㄱ", "ㅅ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "독수리가 날아요." },
  { word: "홍학", targetPhonemes: ["ㅎ", "ㅎ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "홍학이 분홍색이에요." },
  { word: "카멜레온", targetPhonemes: ["ㄱ", "ㅁ", "ㄹ", "ㄴ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "카멜레온이 색이 바뀌어요." },
  { word: "코알라", targetPhonemes: ["ㄱ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "코알라가 나무에 매달려요." },
  { word: "판다", targetPhonemes: ["ㅍ", "ㄴ", "ㄷ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "판다가 대나무를 먹어요." },
  { word: "미어캣", targetPhonemes: ["ㅁ", "ㄱ", "ㄷ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "미어캣이 서 있어요." },
  { word: "수달", targetPhonemes: ["ㅅ", "ㄷ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "수달이 헤엄쳐요." },
  { word: "두루미", targetPhonemes: ["ㄷ", "ㄹ", "ㅁ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "두루미가 날아요." },
  { word: "올빼미", targetPhonemes: ["ㄹ", "ㅂ", "ㅁ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "올빼미가 밤에 울어요.", soundEffect: "부엉부엉" },
  ...
  { word: "홍합", targetPhonemes: ["ㅎ", "ㅎ", "ㅂ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "홍합을 먹어요." },
  ...
  { word: "토끼풀", targetPhonemes: ["ㅌ", "ㄱ", "ㅍ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "토끼풀을 뜯어요." },
  { word: "달팽이", targetPhonemes: ["ㄷ", "ㄹ", "ㅍ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "달팽이가 느리게 가요." },
  { word: "반딧불이", targetPhonemes: ["ㅂ", "ㄴ", "ㄷ", "ㅂ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "반딧불이가 빛나요." },
  { word: "장수풍뎅이", targetPhonemes: ["ㅈ", "ㅅ", "ㅍ", "ㄷ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "장수풍뎅이 뿔이 있어요." },
  { word: "사슴벌레", targetPhonemes: ["ㅅ", "ㅅ", "ㅁ", "ㅂ", "ㄹ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "사슴벌레 집게가 있어요." },

  // ── 음식 심화 (Food) ──────────────────────────────────────────────────────
  { word: "떡볶이", targetPhonemes: ["ㄸ", "ㄱ", "ㅂ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "떡볶이가 매워요." },
  ...
  { word: "삼겹살", targetPhonemes: ["ㅅ", "ㅁ", "ㄱ", "ㅂ", "ㅅ", "ㄹ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "삼겹살을 구워요." },
  { word: "냉면", targetPhonemes: ["ㄴ", "ㅁ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "냉면이 시원해요." },
  ...
  { word: "비빔밥", targetPhonemes: ["ㅂ", "ㅂ", "ㅁ", "ㅂ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "비빔밥을 비벼요." },
  { word: "감자튀김", targetPhonemes: ["ㄱ", "ㅁ", "ㅈ", "ㅌ", "ㄱ", "ㅁ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "감자튀김이 바삭해요." },
  { word: "치킨", targetPhonemes: ["ㅊ", "ㄱ", "ㄴ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "치킨이 맛있어요." },
  { word: "피자", targetPhonemes: ["ㅍ", "ㅈ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "피자를 먹어요." },
  { word: "햄버거", targetPhonemes: ["ㅎ", "ㅁ", "ㅂ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "햄버거를 먹어요." },
  { word: "케이크", targetPhonemes: ["ㄱ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "케이크를 먹어요." },
  { word: "쿠키", targetPhonemes: ["ㄲ", "ㄱ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "쿠키를 구워요." },
  { word: "아이스크림", targetPhonemes: ["ㅅ", "ㄱ", "ㄹ", "ㅁ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "아이스크림이 차가워요." },
  { word: "팝콘", targetPhonemes: ["ㅍ", "ㅂ", "ㄱ", "ㄴ"], difficulty: "hard", ageGroup: "3-4세", sampleSentence: "팝콘이 톡톡 튀어요.", soundEffect: "탁탁" },
  { word: "솜사탕", targetPhonemes: ["ㅅ", "ㅁ", "ㅅ", "ㅌ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "솜사탕이 달아요." },
  { word: "삶은달걀", targetPhonemes: ["ㅅ", "ㄹ", "ㅁ", "ㄷ", "ㄱ", "ㄹ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "삶은달걀을 먹어요." },
  { word: "군고구마", targetPhonemes: ["ㄱ", "ㄴ", "ㄱ", "ㅁ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "군고구마가 달아요." },
  ...
  { word: "타코야끼", targetPhonemes: ["ㅌ", "ㄱ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "타코야끼가 동그래요." },
  { word: "오징어볶음", targetPhonemes: ["ㅈ", "ㅇ", "ㅂ", "ㄱ", "ㅁ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "오징어볶음이 매워요." },
  ...
  { word: "버스", targetPhonemes: ["ㅂ", "ㅅ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "버스를 타요." },
  { word: "자동차", targetPhonemes: ["ㅈ", "ㄷ", "ㅊ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "자동차가 달려요." },
  { word: "오토바이", targetPhonemes: ["ㅌ", "ㅂ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "오토바이가 빨라요.", soundEffect: "부릉부릉" },
  { word: "소방차", targetPhonemes: ["ㅅ", "ㅂ", "ㅊ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "소방차가 달려요.", soundEffect: "삐뽀삐뽀" },
  { word: "구급차", targetPhonemes: ["ㄱ", "ㄱ", "ㅂ", "ㅊ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "구급차가 달려요.", soundEffect: "삐뽀삐뽀" },
  { word: "경찰차", targetPhonemes: ["ㄱ", "ㅈ", "ㅊ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "경찰차가 순찰해요." },
  { word: "굴착기", targetPhonemes: ["ㄱ", "ㄹ", "ㅊ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "굴착기가 땅을 파요." },
  { word: "기중기", targetPhonemes: ["ㄱ", "ㅈ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "기중기가 짐을 들어요." },
  { word: "잠수함", targetPhonemes: ["ㅈ", "ㅁ", "ㅅ", "ㅎ", "ㅁ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "잠수함이 물속에 있어요." },
  { word: "로켓", targetPhonemes: ["ㄹ", "ㄱ", "ㄷ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "로켓이 날아가요.", soundEffect: "슝" },
  { word: "우주선", targetPhonemes: ["ㅈ", "ㅅ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "우주선이 날아요." },
  { word: "케이블카", targetPhonemes: ["ㄱ", "ㄱ", "ㅂ", "ㄹ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "케이블카를 타요." },
  { word: "자전거", targetPhonemes: ["ㅈ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "자전거를 타요." },
  { word: "킥보드", targetPhonemes: ["ㄱ", "ㅂ", "ㄷ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "킥보드를 타요." },

  // ── 신체 부위 심화 (Body Parts) ───────────────────────────────────────────
  { word: "눈썹", targetPhonemes: ["ㄴ", "ㅅ", "ㅂ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "눈썹이 있어요." },
  { word: "속눈썹", targetPhonemes: ["ㅅ", "ㄱ", "ㄴ", "ㅅ", "ㅂ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "속눈썹이 길어요." },
  { word: "볼", targetPhonemes: ["ㅂ", "ㄹ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "볼이 빨개요." },
  { word: "턱", targetPhonemes: ["ㅌ", "ㄱ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "턱을 괴어요." },
  { word: "이마", targetPhonemes: ["ㅁ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "이마가 넓어요." },
  { word: "뒤통수", targetPhonemes: ["ㄷ", "ㅌ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "뒤통수를 만져요." },
  { word: "겨드랑이", targetPhonemes: ["ㄱ", "ㄷ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "겨드랑이가 간지러워요." },
  { word: "손톱", targetPhonemes: ["ㅅ", "ㄴ", "ㅌ", "ㅂ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "손톱을 깎아요." },
  { word: "발톱", targetPhonemes: ["ㅂ", "ㄹ", "ㅌ", "ㅂ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "발톱을 깎아요." },
  ...
  { word: "팔꿈치", targetPhonemes: ["ㅍ", "ㄹ", "ㄲ", "ㅁ", "ㅊ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "팔꿈치를 부딪쳤어요." },
  { word: "갈비뼈", targetPhonemes: ["ㄱ", "ㄹ", "ㅂ", "ㅂ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "갈비뼈가 있어요." },
  { word: "척추", targetPhonemes: ["ㅊ", "ㄱ", "ㅊ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "척추를 펴요." },

  // ── 집·가구 심화 (Home/Furniture) ────────────────────────────────────────
  { word: "소파", targetPhonemes: ["ㅅ", "ㅍ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "소파에 앉아요." },
  { word: "책상", targetPhonemes: ["ㅊ", "ㄱ", "ㅅ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "책상에서 공부해요." },
  { word: "의자", targetPhonemes: ["ㅈ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "의자에 앉아요." },
  { word: "장롱", targetPhonemes: ["ㅈ", "ㄹ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "장롱에 옷을 넣어요." },
  { word: "세탁기", targetPhonemes: ["ㅅ", "ㅌ", "ㄱ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "세탁기로 빨아요." },
  { word: "청소기", targetPhonemes: ["ㅊ", "ㅅ", "ㄱ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "청소기로 빨아요." },
  { word: "전자레인지", targetPhonemes: ["ㅈ", "ㄴ", "ㅈ", "ㄹ", "ㄴ", "ㅈ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "전자레인지로 데워요." },
  { word: "가스레인지", targetPhonemes: ["ㄱ", "ㅅ", "ㄹ", "ㄴ", "ㅈ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "가스레인지로 끓여요." },
  { word: "커튼", targetPhonemes: ["ㄱ", "ㅌ", "ㄴ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "커튼을 쳐요." },
  ...
  { word: "선풍기", targetPhonemes: ["ㅅ", "ㄴ", "ㅍ", "ㄱ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "선풍기를 틀어요.", soundEffect: "윙윙" },
  { word: "에어컨", targetPhonemes: ["ㄱ", "ㄴ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "에어컨이 시원해요." },
  ...
  // ── 스포츠·놀이 (Sports/Play) ─────────────────────────────────────────────
  { word: "축구", targetPhonemes: ["ㅊ", "ㄱ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "축구를 해요." },
  { word: "농구", targetPhonemes: ["ㄴ", "ㄱ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "농구를 해요." },
  ...
  { word: "스키", targetPhonemes: ["ㅅ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "스키를 타요." },
  { word: "스케이트", targetPhonemes: ["ㅅ", "ㄱ", "ㅌ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "스케이트를 타요." },
  { word: "탁구", targetPhonemes: ["ㅌ", "ㄱ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "탁구를 쳐요." },
  { word: "배드민턴", targetPhonemes: ["ㅂ", "ㄷ", "ㅁ", "ㄴ", "ㅌ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "배드민턴을 쳐요." },
  { word: "볼링", targetPhonemes: ["ㅂ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "볼링을 해요." },
  { word: "수영복", targetPhonemes: ["ㅅ", "ㅇ", "ㅂ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "수영복을 입어요." },
  { word: "훌라후프", targetPhonemes: ["ㅎ", "ㄹ", "ㅎ", "ㅍ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "훌라후프를 돌려요." },
  { word: "철봉", targetPhonemes: ["ㅊ", "ㄹ", "ㅂ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "철봉에 매달려요." },
  { word: "평행봉", targetPhonemes: ["ㅍ", "ㅇ", "ㅎ", "ㅂ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "평행봉에서 운동해요." },

  // ── 직업 (Occupations) ────────────────────────────────────────────────────
  { word: "의사", targetPhonemes: ["ㅅ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "의사 선생님이에요." },
  { word: "간호사", targetPhonemes: ["ㄱ", "ㄴ", "ㅎ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "간호사가 도와줘요." },
  { word: "요리사", targetPhonemes: ["ㄹ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "요리사가 만들어요." },
  { word: "소방관", targetPhonemes: ["ㅅ", "ㅂ", "ㄱ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "소방관이 불을 꺼요." },
  { word: "경찰관", targetPhonemes: ["ㄱ", "ㅈ", "ㄱ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "경찰관이 지켜요." },
  { word: "선생님", targetPhonemes: ["ㅅ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "선생님이 가르쳐요." },
  { word: "농부", targetPhonemes: ["ㄴ", "ㅂ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "농부가 농사 지어요." },
  { word: "조종사", targetPhonemes: ["ㅈ", "ㅈ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "조종사가 비행기를 몰아요." },
  ...
  // ── 색깔 심화 (Colors) ────────────────────────────────────────────────────
  { word: "분홍색", targetPhonemes: ["ㅂ", "ㄴ", "ㅎ", "ㄱ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "분홍색이 예뻐요." },
  { word: "주황색", targetPhonemes: ["ㅈ", "ㅎ", "ㄱ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "주황색 당근이에요." },
  { word: "갈색", targetPhonemes: ["ㄱ", "ㄹ", "ㅅ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "갈색 곰이에요." },
  { word: "하늘색", targetPhonemes: ["ㅎ", "ㄴ", "ㄹ", "ㅅ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "하늘색 하늘이에요." },
  { word: "금색", targetPhonemes: ["ㄱ", "ㅁ", "ㅅ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "금색이 반짝여요." },
  ...
  { word: "자주색", targetPhonemes: ["ㅈ", "ㅈ", "ㅅ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "자주색 포도예요." },
  { word: "살구색", targetPhonemes: ["ㅅ", "ㄹ", "ㄱ", "ㅅ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "살구색 얼굴이에요." },
  ...
  { word: "달콤해", targetPhonemes: ["ㄷ", "ㄹ", "ㄱ", "ㅁ", "ㅎ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "달콤해요." },
  { word: "쓰디써", targetPhonemes: ["ㅆ", "ㄷ", "ㅆ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "쓰디써요." },
  { word: "새콤해", targetPhonemes: ["ㅅ", "ㄱ", "ㅁ", "ㅎ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "새콤해요." },
  { word: "짭짤해", targetPhonemes: ["ㅉ", "ㅂ", "ㅈ", "ㄹ", "ㅎ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "짭짤해요." },
  ...
  { word: "바지", targetPhonemes: ["ㅂ", "ㅈ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "바지를 입어요." },
  ...
  { word: "장갑", targetPhonemes: ["ㅈ", "ㄴ", "ㄱ", "ㅂ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "장갑을 껴요." },
  { word: "부츠", targetPhonemes: ["ㅂ", "ㅊ", "ㅅ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "부츠를 신어요." },
  { word: "슬리퍼", targetPhonemes: ["ㅅ", "ㄹ", "ㅍ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "슬리퍼를 신어요." },
  { word: "운동화", targetPhonemes: ["ㄴ", "ㄷ", "ㅎ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "운동화를 신어요." },
  { word: "구두", targetPhonemes: ["ㄱ", "ㄷ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "구두를 신어요." },

  // ── 장소 (Places) ─────────────────────────────────────────────────────────
  { word: "도서관", targetPhonemes: ["ㄷ", "ㅅ", "ㄱ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "도서관에서 책을 읽어요." },
  { word: "박물관", targetPhonemes: ["ㅂ", "ㄱ", "ㅁ", "ㄹ", "ㄱ", "ㄴ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "박물관에 가요." },
  { word: "미술관", targetPhonemes: ["ㅁ", "ㅅ", "ㄹ", "ㄱ", "ㄴ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "미술관에 가요." },
  { word: "수족관", targetPhonemes: ["ㅅ", "ㅈ", "ㄱ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "수족관에서 물고기를 봐요." },
  { word: "놀이공원", targetPhonemes: ["ㄴ", "ㄹ", "ㄱ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "놀이공원에 가요." },
  { word: "편의점", targetPhonemes: ["ㅍ", "ㄴ", "ㅈ", "ㅁ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "편의점에 가요." },
  { word: "약국", targetPhonemes: ["ㄱ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "약국에서 약을 사요." },
  ...
  { word: "기차역", targetPhonemes: ["ㄱ", "ㅊ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "기차역에서 기차를 타요." },

  // ── 자연·환경 (Nature) ────────────────────────────────────────────────────
  { word: "바위", targetPhonemes: ["ㅂ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "바위가 크고 무거워요." },
  ...
  { word: "파도", targetPhonemes: ["ㅍ", "ㄷ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "파도가 밀려와요." },
  { word: "산봉우리", targetPhonemes: ["ㅅ", "ㄴ", "ㅂ", "ㄹ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "산봉우리가 높아요." },
  { word: "계곡", targetPhonemes: ["ㄱ", "ㄱ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "계곡이 시원해요." },
  { word: "폭포", targetPhonemes: ["ㅍ", "ㄱ", "ㅍ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "폭포가 떨어져요." },
  { word: "호수", targetPhonemes: ["ㅎ", "ㅅ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "호수가 잔잔해요." },
  { word: "사막", targetPhonemes: ["ㅅ", "ㅁ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "사막이 뜨거워요." },
  { word: "열대우림", targetPhonemes: ["ㄹ", "ㄷ", "ㅂ", "ㄹ", "ㅁ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "열대우림이 울창해요." },
  ...
  { word: "코스모스", targetPhonemes: ["ㄱ", "ㅅ", "ㅁ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "코스모스가 흔들려요." },
  { word: "수선화", targetPhonemes: ["ㅅ", "ㄴ", "ㅎ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "수선화가 예뻐요." },
  { word: "선인장", targetPhonemes: ["ㅅ", "ㄴ", "ㄴ", "ㅈ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "선인장이 뾰족해요." },
  { word: "대나무", targetPhonemes: ["ㄷ", "ㄴ", "ㅁ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "대나무가 빠르게 자라요." },
  { word: "버섯", targetPhonemes: ["ㅂ", "ㅅ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "버섯이 동글해요." },
  { word: "이끼", targetPhonemes: ["ㄲ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "이끼가 초록색이에요." },
  { word: "단풍잎", targetPhonemes: ["ㄷ", "ㄴ", "ㅍ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "단풍잎이 빨개요." },
  { word: "소나무", targetPhonemes: ["ㅅ", "ㄴ", "ㅁ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "소나무가 늘 푸르러요." },
  { word: "느티나무", targetPhonemes: ["ㄴ", "ㅌ", "ㄴ", "ㅁ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "느티나무가 시원해요." },
  { word: "넝쿨", targetPhonemes: ["ㄴ", "ㄱ", "ㄹ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "넝쿨이 벽을 타요." },

  // ── 날씨·계절 심화 (Seasons/Weather) ────────────────────────────────────
  { word: "봄", targetPhonemes: ["ㅂ", "ㅁ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "봄이 왔어요." },
  { word: "여름", targetPhonemes: ["ㄹ", "ㅁ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "여름이 더워요." },
  { word: "가을", targetPhonemes: ["ㄱ", "ㄹ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "가을이 시원해요." },
  { word: "겨울", targetPhonemes: ["ㄱ", "ㄹ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "겨울이 추워요." },
  ...
  // ── 우주·과학 (Space/Science) ─────────────────────────────────────────────
  { word: "태양", targetPhonemes: ["ㅌ", "ㅇ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "태양이 뜨거워요." },
  { word: "달", targetPhonemes: ["ㄷ", "ㄹ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "달이 밝아요." },
  ...
  { word: "혜성", targetPhonemes: ["ㅎ", "ㅅ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "혜성이 지나가요." },
  { word: "은하수", targetPhonemes: ["ㄴ", "ㅎ", "ㅅ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "은하수가 아름다워요." },
  { word: "망원경", targetPhonemes: ["ㅁ", "ㅇ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "망원경으로 별을 봐요." },
  { word: "로켓", targetPhonemes: ["ㄹ", "ㄱ", "ㄷ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "로켓이 날아가요.", soundEffect: "슝" },
  ...
  { word: "실험", targetPhonemes: ["ㅅ", "ㄹ", "ㅎ", "ㄴ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "실험을 해요." },
  ...
  { word: "바이올린", targetPhonemes: ["ㅂ", "ㄹ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "바이올린을 켜요." },
  { word: "첼로", targetPhonemes: ["ㅊ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "첼로를 켜요." },
  { word: "트럼펫", targetPhonemes: ["ㅌ", "ㄹ", "ㅁ", "ㅍ", "ㄷ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "트럼펫을 불어요.", soundEffect: "빠라밤" },
  { word: "플루트", targetPhonemes: ["ㅍ", "ㄹ", "ㅌ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "플루트를 불어요." },
  ...
  { word: "탬버린", targetPhonemes: ["ㅌ", "ㅁ", "ㅂ", "ㄹ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "탬버린을 흔들어요.", soundEffect: "찰랑찰랑" },
  { word: "마라카스", targetPhonemes: ["ㅁ", "ㄹ", "ㄱ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "마라카스를 흔들어요.", soundEffect: "쌀쌀" },
  { word: "하모니카", targetPhonemes: ["ㅎ", "ㅁ", "ㄴ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "하모니카를 불어요." },
  { word: "피리", targetPhonemes: ["ㅍ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "피리를 불어요.", soundEffect: "삐리리" },
  { word: "북", targetPhonemes: ["ㅂ", "ㄱ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "북을 쳐요.", soundEffect: "둥둥" },

  // ── 미술·공작 (Art/Craft) ─────────────────────────────────────────────────
  { word: "종이접기", targetPhonemes: ["ㅈ", "ㅇ", "ㅈ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "종이접기를 해요." },
  ...
  { word: "스텐실", targetPhonemes: ["ㅅ", "ㅌ", "ㄴ", "ㅅ", "ㄹ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "스텐실로 꾸며요." },
  ...
  { word: "목공예", targetPhonemes: ["ㅁ", "ㄱ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "목공예를 해요." },

  // ── 동작 동사 심화 (Action Verbs) ────────────────────────────────────────
  { word: "두드려", targetPhonemes: ["ㄷ", "ㄷ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "문을 두드려요.", soundEffect: "똑똑" },
  ...
  { word: "건너", targetPhonemes: ["ㄱ", "ㄴ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "건너요." },
  ...
  { word: "가볍다", targetPhonemes: ["ㄱ", "ㅂ", "ㄹ", "ㅂ", "ㄷ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "깃털이 가볍다." },
  ...
  { word: "실례해", targetPhonemes: ["ㅅ", "ㄹ", "ㄹ", "ㅎ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "실례해요." },
  { word: "괜찮아", targetPhonemes: ["ㄲ", "ㄴ", "ㅊ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "괜찮아요." },
  ...
  { word: "나눠요", targetPhonemes: ["ㄴ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "친구와 나눠요." },
  { word: "도와줘", targetPhonemes: ["ㄷ", "ㅈ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "도와줘요." },
  { word: "함께해", targetPhonemes: ["ㅎ", "ㅁ", "ㄲ", "ㅎ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "함께해요." },
  ...
  { word: "샤워", targetPhonemes: ["ㅅ", "ㅇ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "샤워를 해요." },
  { word: "목욕", targetPhonemes: ["ㅁ", "ㄱ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "목욕을 해요." },
  ...
  { word: "소풍", targetPhonemes: ["ㅅ", "ㅍ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "소풍을 가요." },
  { word: "수영", targetPhonemes: ["ㅅ", "ㅇ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "수영을 해요." },
  { word: "단풍구경", targetPhonemes: ["ㄷ", "ㄴ", "ㅍ", "ㄱ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "단풍구경을 가요." },
  { word: "낙엽밟기", targetPhonemes: ["ㄴ", "ㄱ", "ㄹ", "ㅂ", "ㅂ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "낙엽밟기를 해요.", soundEffect: "사각사각" },
  { word: "썰매타기", targetPhonemes: ["ㅆ", "ㄹ", "ㅁ", "ㅌ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "썰매타기를 해요." },
  { word: "눈싸움", targetPhonemes: ["ㄴ", "ㅅ", "ㅆ", "ㅁ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "눈싸움을 해요." },
  { word: "모래놀이", targetPhonemes: ["ㅁ", "ㄹ", "ㄴ", "ㄹ"], difficulty: "hard", ageGroup: "3-4세", sampleSentence: "모래놀이를 해요." },

  // ── 이야기·동화 속 단어 (Fairy Tale Words) ───────────────────────────────
  { word: "마법사", targetPhonemes: ["ㅁ", "ㅂ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "마법사가 마법을 써요." },
  { word: "용", targetPhonemes: ["ㄹ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "용이 불을 뿜어요.", soundEffect: "푸아~" },
  { word: "요정", targetPhonemes: ["ㄹ", "ㅈ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "요정이 날아요." },
  ...
  { word: "난쟁이", targetPhonemes: ["ㄴ", "ㄴ", "ㅈ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "난쟁이가 작아요." },
  ...
  { word: "성곽", targetPhonemes: ["ㅅ", "ㄱ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "성곽이 튼튼해요." },
  ...
  { word: "밥먹기", targetPhonemes: ["ㅂ", "ㅂ", "ㅁ", "ㄱ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "밥을 먹어요." },
  { word: "가방싸기", targetPhonemes: ["ㄱ", "ㅂ", "ㅆ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "가방을 싸요." },
  { word: "등교하기", targetPhonemes: ["ㄷ", "ㄱ", "ㅎ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "학교에 가요." },
  { word: "하교하기", targetPhonemes: ["ㅎ", "ㄱ", "ㅎ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "학교에서 와요." },
  { word: "숙제하기", targetPhonemes: ["ㅅ", "ㄱ", "ㅈ", "ㅎ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "숙제를 해요." },
  { word: "잠자기", targetPhonemes: ["ㅈ", "ㅁ", "ㅈ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "잠을 자요." },

  // ── 한국 전통·문화 (Korean Culture) ──────────────────────────────────────
  { word: "한복", targetPhonemes: ["ㅎ", "ㄴ", "ㅂ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "한복이 예뻐요." },
  { word: "태극기", targetPhonemes: ["ㅌ", "ㄱ", "ㄱ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "태극기를 흔들어요." },
  ...
  { word: "기와", targetPhonemes: ["ㄱ", "ㅇ"], difficulty: "medium", ageGroup: "4-5세", sampleSentence: "기와가 있어요." },
  { word: "도자기", targetPhonemes: ["ㄷ", "ㅈ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "도자기를 만들어요." },
  { word: "장구", targetPhonemes: ["ㅈ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "장구를 쳐요.", soundEffect: "쿵덕쿵" },
  { word: "가야금", targetPhonemes: ["ㄱ", "ㄱ", "ㅁ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "가야금을 타요." },
  ...
  { word: "연날리기", targetPhonemes: ["ㄹ", "ㄴ", "ㄹ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "연을 날려요." },
  { word: "윷놀이", targetPhonemes: ["ㅇ", "ㄴ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "윷놀이를 해요." },
  { word: "팽이", targetPhonemes: ["ㅍ", "ㅇ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "팽이를 돌려요.", soundEffect: "팽팽" },
  { word: "제기차기", targetPhonemes: ["ㅈ", "ㄱ", "ㅊ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "제기차기를 해요." },
  { word: "씨름", targetPhonemes: ["ㅆ", "ㄹ", "ㅁ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "씨름을 해요." },
  { word: "명절", targetPhonemes: ["ㅁ", "ㄴ", "ㅈ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "명절이 즐거워요." },
  { word: "설날", targetPhonemes: ["ㅅ", "ㄹ", "ㄴ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "설날에 떡국을 먹어요." },
  ...
  // ── 음식 심화 (Advanced Food) ─────────────────────────────────────────────
  { word: "김밥", targetPhonemes: ["ㄱ", "ㅁ", "ㅂ", "ㅂ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "김밥을 먹어요." },
  { word: "떡볶이", targetPhonemes: ["ㄸ", "ㄱ", "ㅂ", "ㄲ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "떡볶이가 매워요." },
  { word: "잡채", targetPhonemes: ["ㅈ", "ㅂ", "ㅊ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "잡채가 맛있어요." },
  { word: "불고기", targetPhonemes: ["ㅂ", "ㄹ", "ㄱ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "불고기가 맛있어요." },
  { word: "삼겹살", targetPhonemes: ["ㅅ", "ㅁ", "ㄱ", "ㅂ", "ㅅ", "ㄹ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "삼겹살을 구워요." },
  { word: "비빔밥", targetPhonemes: ["ㅂ", "ㅂ", "ㅁ", "ㅂ", "ㅂ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "비빔밥을 비벼요." },
  { word: "순두부", targetPhonemes: ["ㅅ", "ㄴ", "ㄷ", "ㅂ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "순두부를 먹어요." },
  { word: "냉면", targetPhonemes: ["ㄴ", "ㅇ", "ㅁ", "ㄴ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "냉면이 시원해요." },
  { word: "칼국수", targetPhonemes: ["ㄱ", "ㄱ", "ㅅ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "칼국수가 따뜻해요." },
  { word: "된장국", targetPhonemes: ["ㄷ", "ㄴ", "ㅈ", "ㅇ", "ㄱ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "된장국이 맛있어요." },
  ...
  { word: "피자", targetPhonemes: ["ㅍ", "ㅈ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "피자가 맛있어요." },
  { word: "햄버거", targetPhonemes: ["ㅎ", "ㅁ", "ㅂ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "햄버거를 먹어요." },
  { word: "치킨", targetPhonemes: ["ㅊ", "ㄱ", "ㄴ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "치킨이 맛있어요." },
  { word: "아이스크림", targetPhonemes: ["ㅇ", "ㅅ", "ㄱ", "ㄹ", "ㅁ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "아이스크림이 달아요." },
  { word: "케이크", targetPhonemes: ["ㄱ", "ㅇ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "케이크를 먹어요." },
  { word: "쿠키", targetPhonemes: ["ㄱ", "ㄱ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "쿠키가 맛있어요." },
  { word: "초콜릿", targetPhonemes: ["ㅊ", "ㄱ", "ㄹ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "초콜릿이 달아요." },
  { word: "사탕", targetPhonemes: ["ㅅ", "ㅌ", "ㅇ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "사탕이 달아요." },
  { word: "젤리", targetPhonemes: ["ㅈ", "ㄹ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "젤리를 먹어요." },
  { word: "팝콘", targetPhonemes: ["ㅍ", "ㅂ", "ㄱ", "ㄴ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "팝콘을 먹어요.", soundEffect: "팡팡" },
  { word: "주스", targetPhonemes: ["ㅈ", "ㅅ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "주스를 마셔요." },
  { word: "두유", targetPhonemes: ["ㄷ", "ㅇ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "두유를 마셔요." },
  { word: "요구르트", targetPhonemes: ["ㄹ", "ㄱ", "ㅅ", "ㅌ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "요구르트를 먹어요." },
  { word: "치즈", targetPhonemes: ["ㅊ", "ㅈ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "치즈가 맛있어요." },
  { word: "버터", targetPhonemes: ["ㅂ", "ㅌ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "버터를 발라요." },
  { word: "잼", targetPhonemes: ["ㅈ", "ㅁ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "잼을 발라요." },
  { word: "꿀", targetPhonemes: ["ㄲ", "ㄹ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "꿀이 달아요." },
  { word: "소금", targetPhonemes: ["ㅅ", "ㄱ", "ㄱ", "ㅁ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "소금을 넣어요." },
  { word: "설탕", targetPhonemes: ["ㅅ", "ㄹ", "ㅌ", "ㅇ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "설탕이 달아요." },

  // ── 동물 심화 (Advanced Animals) ─────────────────────────────────────────
  { word: "독수리", targetPhonemes: ["ㄷ", "ㄱ", "ㅅ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "독수리가 날아요." },
  { word: "공작새", targetPhonemes: ["ㄱ", "ㅇ", "ㅈ", "ㄱ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "공작새가 예뻐요." },
  { word: "플라밍고", targetPhonemes: ["ㅍ", "ㄹ", "ㅁ", "ㄴ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "플라밍고가 분홍이에요." },
  ...
  { word: "딱따구리", targetPhonemes: ["ㄸ", "ㄱ", "ㄸ", "ㄱ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "딱따구리가 나무를 쪼아요.", soundEffect: "딱딱" },
  { word: "올빼미", targetPhonemes: ["ㄹ", "ㅂ", "ㄱ", "ㅁ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "올빼미가 울어요.", soundEffect: "부엉부엉" },
  { word: "박쥐", targetPhonemes: ["ㅂ", "ㄱ", "ㅈ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "박쥐가 날아요." },
  { word: "고슴도치", targetPhonemes: ["ㄱ", "ㅅ", "ㅁ", "ㄷ", "ㅊ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "고슴도치에게 가시가 있어요." },
  { word: "두더지", targetPhonemes: ["ㄷ", "ㄷ", "ㅈ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "두더지가 땅을 파요." },
  ...
  { word: "복어", targetPhonemes: ["ㅂ", "ㄱ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "복어가 부풀어요." },
  { word: "뱀장어", targetPhonemes: ["ㅂ", "ㅁ", "ㅈ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "뱀장어가 길어요." },
  { word: "전갈", targetPhonemes: ["ㅈ", "ㄴ", "ㄱ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "전갈이 무서워요." },
  { word: "타란툴라", targetPhonemes: ["ㅌ", "ㄹ", "ㄴ", "ㅌ", "ㄹ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "타란툴라가 커요." },
  { word: "도마뱀", targetPhonemes: ["ㄷ", "ㅁ", "ㅂ", "ㅁ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "도마뱀이 기어요." },
  { word: "이구아나", targetPhonemes: ["ㄱ", "ㄴ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "이구아나가 햇볕을 쬐어요." },
  { word: "카멜레온", targetPhonemes: ["ㄱ", "ㅁ", "ㄹ", "ㄴ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "카멜레온이 색이 바뀌어요." },
  { word: "알파카", targetPhonemes: ["ㄹ", "ㅍ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "알파카 털이 복슬복슬해요." },
  { word: "라마", targetPhonemes: ["ㄹ", "ㅁ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "라마가 귀여워요." },
  { word: "재규어", targetPhonemes: ["ㅈ", "ㄱ", "ㅇ"], difficulty: "medium", ageGroup: "4-5세", sampleSentence: "재규어가 빨라요." },
  ...
  { word: "홍학", targetPhonemes: ["ㅎ", "ㅇ", "ㅎ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "홍학이 분홍이에요." },
  { word: "왜가리", targetPhonemes: ["ㅇ", "ㄱ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "왜가리가 서 있어요." },
  { word: "청개구리", targetPhonemes: ["ㅊ", "ㅇ", "ㄱ", "ㄱ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "청개구리가 울어요.", soundEffect: "개굴개굴" },

  // ── 직업 심화 (Advanced Occupations) ─────────────────────────────────────
  { word: "수의사", targetPhonemes: ["ㅅ", "ㅇ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "수의사가 동물을 치료해요." },
  { word: "약사", targetPhonemes: ["ㄱ", "ㅅ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "약사가 약을 줘요." },
  { word: "간호사", targetPhonemes: ["ㄱ", "ㄴ", "ㅎ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "간호사가 돌봐줘요." },
  { word: "건축가", targetPhonemes: ["ㄱ", "ㄴ", "ㅊ", "ㄱ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "건축가가 집을 설계해요." },
  { word: "화가", targetPhonemes: ["ㅎ", "ㄱ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "화가가 그림을 그려요." },
  { word: "음악가", targetPhonemes: ["ㅇ", "ㅁ", "ㄱ", "ㄱ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "음악가가 음악을 만들어요." },
  { word: "작가", targetPhonemes: ["ㅈ", "ㄱ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "작가가 책을 써요." },
  { word: "기자", targetPhonemes: ["ㄱ", "ㅈ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "기자가 소식을 전해요." },
  { word: "운동선수", targetPhonemes: ["ㄴ", "ㄷ", "ㅅ", "ㄴ", "ㅅ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "운동선수가 달려요." },
  { word: "경찰관", targetPhonemes: ["ㄱ", "ㅇ", "ㄱ", "ㅊ", "ㄹ", "ㄱ", "ㄴ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "경찰관이 지켜줘요." },
  { word: "소방관", targetPhonemes: ["ㅅ", "ㅂ", "ㄱ", "ㄱ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "소방관이 불을 꺼요." },
  { word: "우체부", targetPhonemes: ["ㅇ", "ㅊ", "ㅂ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "우체부가 편지를 가져요." },
  { word: "파일럿", targetPhonemes: ["ㅍ", "ㄹ", "ㄱ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "파일럿이 비행기를 몰아요." },
  ...
  { word: "축구", targetPhonemes: ["ㅊ", "ㄱ", "ㄱ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "축구를 해요." },
  { word: "야구", targetPhonemes: ["ㄱ", "ㄱ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "야구를 해요." },
  ...
  { word: "탁구", targetPhonemes: ["ㅌ", "ㄱ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "탁구를 쳐요." },
  { word: "배드민턴", targetPhonemes: ["ㅂ", "ㄷ", "ㅁ", "ㄴ", "ㅌ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "배드민턴을 쳐요." },
  ...
  { word: "태권도", targetPhonemes: ["ㅌ", "ㄱ", "ㄴ", "ㄷ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "태권도를 해요." },
  { word: "유도", targetPhonemes: ["ㄷ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "유도를 해요." },
  { word: "체조", targetPhonemes: ["ㅊ", "ㅈ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "체조를 해요." },
  { word: "스케이팅", targetPhonemes: ["ㅅ", "ㄱ", "ㅇ", "ㅌ", "ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "스케이팅을 해요." },
  { word: "스키", targetPhonemes: ["ㅅ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "스키를 타요." },
  { word: "서핑", targetPhonemes: ["ㅅ", "ㅍ", "ㅇ"], difficulty: "medium", ageGroup: "4-5세", sampleSentence: "서핑을 해요." },
  { word: "사이클", targetPhonemes: ["ㅅ", "ㄱ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "사이클을 타요." },
  { word: "마라톤", targetPhonemes: ["ㅁ", "ㄹ", "ㅌ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "마라톤을 달려요." },
  { word: "양궁", targetPhonemes: ["ㅇ", "ㄱ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "양궁을 해요." },
  ...
  // ── 여행·장소 (Travel/Places) ─────────────────────────────────────────────
  { word: "공항", targetPhonemes: ["ㄱ", "ㅇ", "ㅎ", "ㅇ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "공항에서 비행기를 타요." },
  { word: "기차역", targetPhonemes: ["ㄱ", "ㅊ", "ㄱ", "ㅇ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "기차역에서 기다려요." },
  ...
  { word: "등대", targetPhonemes: ["ㄷ", "ㅇ", "ㄷ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "등대가 빛나요." },
  { word: "박물관", targetPhonemes: ["ㅂ", "ㄱ", "ㅁ", "ㄹ", "ㄱ", "ㄴ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "박물관에 가요." },
  { word: "미술관", targetPhonemes: ["ㅁ", "ㅅ", "ㄹ", "ㄱ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "미술관에서 그림을 봐요." },
  { word: "놀이공원", targetPhonemes: ["ㄴ", "ㄹ", "ㄱ", "ㅇ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "놀이공원이 재미있어요." },
  { word: "수족관", targetPhonemes: ["ㅅ", "ㅈ", "ㄱ", "ㄱ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "수족관에 물고기가 있어요." },
  { word: "식물원", targetPhonemes: ["ㅅ", "ㄱ", "ㅁ", "ㄹ", "ㅇ", "ㄴ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "식물원에 꽃이 많아요." },
  { word: "캠핑장", targetPhonemes: ["ㄱ", "ㅁ", "ㅍ", "ㅇ", "ㅈ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "캠핑장에서 자요." },
  { word: "계곡", targetPhonemes: ["ㄱ", "ㄱ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "계곡이 시원해요." },
  { word: "폭포", targetPhonemes: ["ㅍ", "ㄱ", "ㅍ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "폭포가 시원해요.", soundEffect: "철철" },
  ...
  { word: "편의점", targetPhonemes: ["ㅍ", "ㄴ", "ㅇ", "ㅈ", "ㅁ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "편의점에서 사요." },
  { word: "백화점", targetPhonemes: ["ㅂ", "ㄱ", "ㅎ", "ㅈ", "ㅁ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "백화점에서 옷을 사요." },
  { word: "세탁소", targetPhonemes: ["ㅅ", "ㅌ", "ㄱ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "세탁소에 맡겨요." },

  // ── 기술·전자기기 (Technology) ────────────────────────────────────────────
  { word: "컴퓨터", targetPhonemes: ["ㄱ", "ㅁ", "ㅍ", "ㅌ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "컴퓨터로 해요." },
  { word: "태블릿", targetPhonemes: ["ㅌ", "ㅂ", "ㄹ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "태블릿으로 봐요." },
  { word: "스마트폰", targetPhonemes: ["ㅅ", "ㅁ", "ㅅ", "ㅍ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "스마트폰으로 전화해요." },
  { word: "충전기", targetPhonemes: ["ㅊ", "ㅇ", "ㅈ", "ㄴ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "충전기에 꽂아요." },
  { word: "이어폰", targetPhonemes: ["ㅇ", "ㅍ", "ㄴ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "이어폰을 끼워요." },
  { word: "리모컨", targetPhonemes: ["ㄹ", "ㅁ", "ㄱ", "ㄴ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "리모컨으로 켜요." },
  { word: "카메라", targetPhonemes: ["ㄱ", "ㅁ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "카메라로 찍어요." },
  ...
  { word: "키보드", targetPhonemes: ["ㄱ", "ㅂ", "ㄷ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "키보드를 두드려요.", soundEffect: "딸깍딸깍" },
  ...
  { word: "인터넷", targetPhonemes: ["ㄴ", "ㅌ", "ㄴ", "ㅅ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "인터넷을 해요." },
  { word: "게임기", targetPhonemes: ["ㄱ", "ㅁ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "게임기로 놀아요." },

  // ── 감정·표현 심화 (Advanced Emotions) ───────────────────────────────────
  { word: "신나요", targetPhonemes: ["ㅅ", "ㄴ", "ㄴ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "신나요!" },
  { word: "설레요", targetPhonemes: ["ㅅ", "ㄹ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "설레요." },
  { word: "부끄러워요", targetPhonemes: ["ㅂ", "ㄲ", "ㄹ", "ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "부끄러워요." },
  ...
  { word: "자랑스러워요", targetPhonemes: ["ㅈ", "ㄹ", "ㅅ", "ㄹ", "ㅇ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "자랑스러워요." },
  { word: "그리워요", targetPhonemes: ["ㄱ", "ㄹ", "ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "그리워요." },
  { word: "힘들어요", targetPhonemes: ["ㅎ", "ㅁ", "ㄷ", "ㄹ", "ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "힘들어요." },
  { word: "걱정돼요", targetPhonemes: ["ㄱ", "ㅈ", "ㅇ", "ㄷ", "ㅇ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "걱정돼요." },
  ...
  { word: "목말라요", targetPhonemes: ["ㅁ", "ㄱ", "ㅁ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "목말라요." },
  { word: "졸려요", targetPhonemes: ["ㅈ", "ㄹ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "졸려요." },

  // ── 방향·위치 (Direction/Position) ───────────────────────────────────────
  { word: "앞", targetPhonemes: ["ㅍ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "앞에 있어요." },
  { word: "뒤", targetPhonemes: ["ㄷ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "뒤에 있어요." },
  { word: "왼쪽", targetPhonemes: ["ㅇ", "ㄴ", "ㅉ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "왼쪽으로 가요." },
  ...
  { word: "위", targetPhonemes: ["ㅇ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "위에 있어요." },
  { word: "아래", targetPhonemes: ["ㄹ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "아래에 있어요." },
  { word: "안", targetPhonemes: ["ㄴ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "안에 있어요." },
  { word: "밖", targetPhonemes: ["ㅂ", "ㄱ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "밖에 있어요." },
  { word: "옆", targetPhonemes: ["ㄹ", "ㅂ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "옆에 있어요." },
  { word: "사이", targetPhonemes: ["ㅅ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "사이에 있어요." },
  { word: "북쪽", targetPhonemes: ["ㅂ", "ㄱ", "ㅉ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "북쪽으로 가요." },
  ...
  { word: "다이아몬드", targetPhonemes: ["ㄷ", "ㅇ", "ㅁ", "ㄴ", "ㄷ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "다이아몬드 모양이에요." },
  { word: "줄무늬", targetPhonemes: ["ㅈ", "ㄹ", "ㅁ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "줄무늬가 있어요." },
  { word: "물결무늬", targetPhonemes: ["ㅁ", "ㄹ", "ㄱ", "ㄹ", "ㅁ", "ㄴ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "물결무늬가 예뻐요." },
  { word: "체크무늬", targetPhonemes: ["ㅊ", "ㄱ", "ㅁ", "ㄴ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "체크무늬 옷이에요." },
  { word: "점박이", targetPhonemes: ["ㅈ", "ㅁ", "ㅂ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "점박이 무늬예요." },
  { word: "구불구불", targetPhonemes: ["ㄱ", "ㅂ", "ㄹ", "ㄱ", "ㅂ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "구불구불 선이에요.", soundEffect: "구불구불" },
  { word: "반짝반짝", targetPhonemes: ["ㅂ", "ㄴ", "ㅉ", "ㄱ", "ㅂ", "ㄴ", "ㅉ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "반짝반짝 빛나요.", soundEffect: "반짝반짝" },

  // ── 신체 심화 (Advanced Body Parts) ──────────────────────────────────────
  { word: "눈썹", targetPhonemes: ["ㄴ", "ㄴ", "ㅆ", "ㅂ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "눈썹이 있어요." },
  { word: "속눈썹", targetPhonemes: ["ㅅ", "ㄱ", "ㄴ", "ㄴ", "ㅆ", "ㅂ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "속눈썹이 길어요." },
  { word: "콧구멍", targetPhonemes: ["ㄱ", "ㅅ", "ㄱ", "ㅁ", "ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "콧구멍이 두 개예요." },
  { word: "귓볼", targetPhonemes: ["ㄱ", "ㄹ", "ㅂ", "ㄹ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "귓볼을 잡아요." },
  { word: "발목", targetPhonemes: ["ㅂ", "ㄹ", "ㅁ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "발목이 아파요." },
  { word: "손목", targetPhonemes: ["ㅅ", "ㄴ", "ㅁ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "손목을 돌려요." },
  { word: "무릎", targetPhonemes: ["ㅁ", "ㄹ", "ㅍ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "무릎을 굽혀요." },
  { word: "팔꿈치", targetPhonemes: ["ㅍ", "ㄹ", "ㄲ", "ㅁ", "ㅊ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "팔꿈치가 아파요." },
  { word: "겨드랑이", targetPhonemes: ["ㄱ", "ㄷ", "ㄹ", "ㅇ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "겨드랑이가 간지러워요." },
  { word: "손바닥", targetPhonemes: ["ㅅ", "ㄴ", "ㅂ", "ㄷ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "손바닥을 펴요." },
  { word: "발바닥", targetPhonemes: ["ㅂ", "ㄹ", "ㅂ", "ㄷ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "발바닥이 간지러워요." },
  ...
  { word: "새끼손가락", targetPhonemes: ["ㅅ", "ㄲ", "ㅅ", "ㄴ", "ㄱ", "ㄹ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "새끼손가락이 작아요." },

  // ── 색깔·빛 심화 (Advanced Colors/Light) ─────────────────────────────────
  { word: "금색", targetPhonemes: ["ㄱ", "ㅁ", "ㅅ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "금색이 반짝여요." },
  { word: "은색", targetPhonemes: ["ㅇ", "ㄴ", "ㅅ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "은색이 빛나요." },
  { word: "하늘색", targetPhonemes: ["ㅎ", "ㄴ", "ㄹ", "ㅅ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "하늘색이 예뻐요." },
  { word: "연두색", targetPhonemes: ["ㄹ", "ㄴ", "ㄷ", "ㅅ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "연두색 풀이에요." },
  { word: "보라색", targetPhonemes: ["ㅂ", "ㄹ", "ㅅ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "보라색 꽃이에요." },
  { word: "분홍색", targetPhonemes: ["ㅂ", "ㄴ", "ㅎ", "ㅇ", "ㅅ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "분홍색이 예뻐요." },
  { word: "갈색", targetPhonemes: ["ㄱ", "ㄹ", "ㅅ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "갈색 곰이에요." },
  ...
  { word: "무지개색", targetPhonemes: ["ㅁ", "ㅈ", "ㄱ", "ㅅ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "무지개색이 예뻐요." },

  // ── 시간·날짜 (Time/Date) ─────────────────────────────────────────────────
  { word: "자정", targetPhonemes: ["ㅈ", "ㅈ", "ㅇ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "자정에는 자요." },
  ...
  { word: "일주일", targetPhonemes: ["ㄹ", "ㅈ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "일주일 후에 가요." },
  { word: "한달", targetPhonemes: ["ㅎ", "ㄴ", "ㄷ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "한달이 지났어요." },

  // ── 한국어 의성어·의태어 심화 ────────────────────────────────────────────
  { word: "쿵쾅쿵쾅", targetPhonemes: ["ㄱ", "ㅇ", "ㄱ", "ㄱ", "ㅇ", "ㄱ"], difficulty: "hard", ageGroup: "3-4세", sampleSentence: "쿵쾅쿵쾅 뛰어요.", soundEffect: "쿵쾅쿵쾅" },
  { word: "달그락달그락", targetPhonemes: ["ㄷ", "ㄹ", "ㄱ", "ㄹ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "달그락달그락 소리나요.", soundEffect: "달그락달그락" },
  { word: "찰랑찰랑", targetPhonemes: ["ㅊ", "ㄹ", "ㅇ", "ㅊ", "ㄹ", "ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "물이 찰랑찰랑해요.", soundEffect: "찰랑찰랑" },
  { word: "뽀글뽀글", targetPhonemes: ["ㅃ", "ㄱ", "ㄹ", "ㅃ", "ㄱ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "국이 뽀글뽀글해요.", soundEffect: "뽀글뽀글" },
  { word: "사각사각", targetPhonemes: ["ㅅ", "ㄱ", "ㄱ", "ㅅ", "ㄱ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "눈이 사각사각해요.", soundEffect: "사각사각" },
  { word: "쫄깃쫄깃", targetPhonemes: ["ㅉ", "ㄹ", "ㄱ", "ㅅ", "ㅉ", "ㄹ", "ㄱ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "떡이 쫄깃쫄깃해요.", soundEffect: "쫄깃쫄깃" },
  { word: "보슬보슬", targetPhonemes: ["ㅂ", "ㅅ", "ㄹ", "ㅂ", "ㅅ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "비가 보슬보슬 내려요.", soundEffect: "보슬보슬" },
  { word: "주룩주룩", targetPhonemes: ["ㅈ", "ㄹ", "ㄱ", "ㅈ", "ㄹ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "비가 주룩주룩 내려요.", soundEffect: "주룩주룩" },
  { word: "폴짝폴짝", targetPhonemes: ["ㅍ", "ㄹ", "ㅉ", "ㄱ", "ㅍ", "ㄹ", "ㅉ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "개구리가 폴짝폴짝 뛰어요.", soundEffect: "폴짝폴짝" },
  { word: "살금살금", targetPhonemes: ["ㅅ", "ㄹ", "ㄱ", "ㅁ", "ㅅ", "ㄹ", "ㄱ", "ㅁ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "살금살금 걸어요.", soundEffect: "살금살금" },
  { word: "엉금엉금", targetPhonemes: ["ㅇ", "ㄱ", "ㅁ", "ㅇ", "ㄱ", "ㅁ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "거북이가 엉금엉금 기어요.", soundEffect: "엉금엉금" },
  { word: "뒤뚱뒤뚱", targetPhonemes: ["ㄷ", "ㅌ", "ㅇ", "ㄷ", "ㅌ", "ㅇ"], difficulty: "hard", ageGroup: "3-4세", sampleSentence: "펭귄이 뒤뚱뒤뚱 걸어요.", soundEffect: "뒤뚱뒤뚱" },
  { word: "깡충깡충", targetPhonemes: ["ㄲ", "ㅇ", "ㅊ", "ㅇ", "ㄲ", "ㅇ", "ㅊ", "ㅇ"], difficulty: "hard", ageGroup: "3-4세", sampleSentence: "토끼가 깡충깡충 뛰어요.", soundEffect: "깡충깡충" },
  { word: "알록달록", targetPhonemes: ["ㄹ", "ㄱ", "ㄷ", "ㄹ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "알록달록 꽃이 피었어요." },
  { word: "새콤달콤", targetPhonemes: ["ㅅ", "ㄱ", "ㅁ", "ㄷ", "ㄹ", "ㄱ", "ㅁ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "새콤달콤 맛이에요." },
  { word: "달달하다", targetPhonemes: ["ㄷ", "ㄹ", "ㄷ", "ㄹ", "ㅎ", "ㄷ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "사탕이 달달해요." },
  { word: "싱싱해요", targetPhonemes: ["ㅅ", "ㅇ", "ㅅ", "ㅇ", "ㅎ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "과일이 싱싱해요." },

  // ── 과일·채소 심화 (Advanced Fruits/Vegetables) ───────────────────────────
  { word: "멜론", targetPhonemes: ["ㅁ", "ㄹ", "ㄴ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "멜론이 달아요." },
  { word: "파인애플", targetPhonemes: ["ㅍ", "ㄴ", "ㅇ", "ㅍ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "파인애플이 달아요." },
  { word: "망고", targetPhonemes: ["ㅁ", "ㅇ", "ㄱ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "망고가 달아요." },
  { word: "코코넛", targetPhonemes: ["ㄱ", "ㄱ", "ㄴ", "ㅅ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "코코넛을 마셔요." },
  { word: "리치", targetPhonemes: ["ㄹ", "ㅊ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "리치가 달아요." },
  { word: "무화과", targetPhonemes: ["ㅁ", "ㅎ", "ㄱ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "무화과가 맛있어요." },
  ...
  { word: "호박", targetPhonemes: ["ㅎ", "ㅂ", "ㄱ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "호박이 노래요." },
  { word: "가지", targetPhonemes: ["ㄱ", "ㅈ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "가지가 보라색이에요." },
  { word: "아스파라거스", targetPhonemes: ["ㅅ", "ㅍ", "ㄹ", "ㄱ", "ㅅ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "아스파라거스를 먹어요." },
  { word: "브로콜리", targetPhonemes: ["ㅂ", "ㄹ", "ㄱ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "브로콜리를 먹어요." },
  { word: "셀러리", targetPhonemes: ["ㅅ", "ㄹ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "셀러리를 먹어요." },
  { word: "버섯", targetPhonemes: ["ㅂ", "ㄱ", "ㅅ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "버섯이 맛있어요." },
  { word: "콩나물", targetPhonemes: ["ㄱ", "ㅇ", "ㄴ", "ㅁ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "콩나물을 먹어요." },
  { word: "두부", targetPhonemes: ["ㄷ", "ㅂ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "두부를 먹어요." },
  { word: "마늘", targetPhonemes: ["ㅁ", "ㄴ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "마늘이 있어요." },
  { word: "생강", targetPhonemes: ["ㅅ", "ㅇ", "ㄱ", "ㅇ"], difficulty: "medium", ageGroup: "4-5세", sampleSentence: "생강차를 마셔요." },
  ...
  { word: "베란다", targetPhonemes: ["ㅂ", "ㄹ", "ㄴ", "ㄷ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "베란다에서 봐요." },
  { word: "발코니", targetPhonemes: ["ㅂ", "ㄹ", "ㄱ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "발코니에 꽃이 있어요." },
  { word: "창고", targetPhonemes: ["ㅊ", "ㅇ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "창고에 넣어요." },
  { word: "다용도실", targetPhonemes: ["ㄷ", "ㅇ", "ㄷ", "ㅅ", "ㄹ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "다용도실에 있어요." },
  { word: "붙박이장", targetPhonemes: ["ㅂ", "ㄱ", "ㅂ", "ㅈ", "ㅇ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "붙박이장에 넣어요." },
  { word: "서랍장", targetPhonemes: ["ㅅ", "ㄹ", "ㅂ", "ㅈ", "ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "서랍장에 넣어요." },
  { word: "식탁", targetPhonemes: ["ㅅ", "ㄱ", "ㅌ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "식탁에 앉아요." },
  { word: "소파", targetPhonemes: ["ㅅ", "ㅍ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "소파에 앉아요." },
  { word: "책상", targetPhonemes: ["ㅊ", "ㄱ", "ㅅ", "ㅇ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "책상에서 공부해요." },
  ...
  { word: "세탁기", targetPhonemes: ["ㅅ", "ㅌ", "ㄱ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "세탁기를 돌려요.", soundEffect: "웅웅" },
  { word: "청소기", targetPhonemes: ["ㅊ", "ㅇ", "ㅅ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "청소기를 돌려요.", soundEffect: "웅웅" },

  // ── 자연·환경 심화 (Advanced Nature/Environment) ──────────────────────────
  { word: "오로라", targetPhonemes: ["ㄹ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "오로라가 아름다워요." },
  { word: "황사", targetPhonemes: ["ㅎ", "ㅇ", "ㅅ"], difficulty: "medium", ageGroup: "4-5세", sampleSentence: "황사가 날아요." },
  { word: "미세먼지", targetPhonemes: ["ㅁ", "ㅅ", "ㅁ", "ㄴ", "ㅈ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "미세먼지가 많아요." },
  { word: "무지개", targetPhonemes: ["ㅁ", "ㅈ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "무지개가 아름다워요." },
  { word: "번개", targetPhonemes: ["ㅂ", "ㄴ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "번개가 쳐요.", soundEffect: "번쩍" },
  { word: "천둥", targetPhonemes: ["ㅊ", "ㄴ", "ㄷ", "ㅇ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "천둥이 쳐요.", soundEffect: "쾅" },
  { word: "안개", targetPhonemes: ["ㄴ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "안개가 끼었어요." },
  ...
  { word: "열대우림", targetPhonemes: ["ㄹ", "ㄷ", "ㅇ", "ㄹ", "ㅁ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "열대우림이 울창해요." },
  ...
  { word: "고속버스", targetPhonemes: ["ㄱ", "ㅅ", "ㄱ", "ㅂ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "고속버스를 타요." },
  { word: "시내버스", targetPhonemes: ["ㅅ", "ㄴ", "ㅂ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "시내버스를 타요." },
  { word: "마을버스", targetPhonemes: ["ㅁ", "ㄹ", "ㅂ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "마을버스를 타요." },
  { word: "지하철", targetPhonemes: ["ㅈ", "ㅎ", "ㅊ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "지하철을 타요." },
  { word: "급행열차", targetPhonemes: ["ㄱ", "ㅂ", "ㅎ", "ㄱ", "ㄹ", "ㅊ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "급행열차가 빨라요." },
  { word: "케이블카", targetPhonemes: ["ㄱ", "ㅂ", "ㄹ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "케이블카를 타요." },
  { word: "모노레일", targetPhonemes: ["ㅁ", "ㄴ", "ㄹ", "ㄹ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "모노레일을 타요." },
  { word: "유람선", targetPhonemes: ["ㄹ", "ㄹ", "ㅅ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "유람선을 타요." },
  { word: "잠수함", targetPhonemes: ["ㅈ", "ㅁ", "ㅅ", "ㅎ", "ㅁ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "잠수함이 잠겨요." },
  { word: "열기구", targetPhonemes: ["ㄹ", "ㄱ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "열기구가 날아요." },
  { word: "글라이더", targetPhonemes: ["ㄱ", "ㄹ", "ㄷ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "글라이더가 날아요." },
  { word: "경운기", targetPhonemes: ["ㄱ", "ㅇ", "ㄴ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "경운기가 달려요." },
  { word: "굴착기", targetPhonemes: ["ㄱ", "ㄹ", "ㅊ", "ㄱ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "굴착기가 파요.", soundEffect: "드르륵" },
  { word: "소방차", targetPhonemes: ["ㅅ", "ㅂ", "ㅊ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "소방차가 달려요.", soundEffect: "삐뽀삐뽀" },
  { word: "구급차", targetPhonemes: ["ㄱ", "ㄱ", "ㅊ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "구급차가 달려요.", soundEffect: "삐뽀삐뽀" },

  // ── 학교·교육 (School/Education) ─────────────────────────────────────────
  { word: "교실", targetPhonemes: ["ㄱ", "ㅅ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "교실에서 공부해요." },
  { word: "도서관", targetPhonemes: ["ㄷ", "ㅅ", "ㄱ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "도서관에서 책을 읽어요." },
  { word: "운동장", targetPhonemes: ["ㄴ", "ㄷ", "ㅈ", "ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "운동장에서 달려요." },
  { word: "칠판", targetPhonemes: ["ㅊ", "ㄹ", "ㅂ", "ㄴ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "칠판에 써요." },
  { word: "분필", targetPhonemes: ["ㅂ", "ㄴ", "ㅍ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "분필로 써요." },
  { word: "지우개", targetPhonemes: ["ㅈ", "ㄱ", "ㅇ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "지우개로 지워요." },
  { word: "공책", targetPhonemes: ["ㄱ", "ㅇ", "ㅊ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "공책에 써요." },
  { word: "색연필", targetPhonemes: ["ㅅ", "ㄱ", "ㄴ", "ㅂ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "색연필로 색칠해요." },
  { word: "크레용", targetPhonemes: ["ㄱ", "ㄹ", "ㅇ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "크레용으로 그려요." },
  { word: "물감", targetPhonemes: ["ㅁ", "ㄹ", "ㄱ", "ㅁ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "물감으로 그려요." },
  ...
  { word: "과학", targetPhonemes: ["ㄱ", "ㅎ", "ㄱ"], difficulty: "medium", ageGroup: "4-5세", sampleSentence: "과학 실험을 해요." },
  { word: "미술", targetPhonemes: ["ㅁ", "ㅅ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "미술 시간이에요." },
  { word: "음악", targetPhonemes: ["ㅇ", "ㅁ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "음악을 들어요." },
  { word: "체육", targetPhonemes: ["ㅊ", "ㅂ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "체육을 해요." },

  // ── 가족·관계 (Family/Relations) ─────────────────────────────────────────
  { word: "외할머니", targetPhonemes: ["ㅇ", "ㅎ", "ㄹ", "ㅁ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "외할머니가 좋아요." },
  { word: "외할아버지", targetPhonemes: ["ㅇ", "ㅎ", "ㄹ", "ㅂ", "ㅈ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "외할아버지가 좋아요." },
  { word: "친할머니", targetPhonemes: ["ㅊ", "ㄴ", "ㅎ", "ㄹ", "ㅁ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "친할머니가 보고 싶어요." },
  { word: "친할아버지", targetPhonemes: ["ㅊ", "ㄴ", "ㅎ", "ㄹ", "ㅂ", "ㅈ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "친할아버지가 보고 싶어요." },
  { word: "외삼촌", targetPhonemes: ["ㅇ", "ㅅ", "ㅁ", "ㅊ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "외삼촌이 왔어요." },
  ...
  { word: "조카", targetPhonemes: ["ㅈ", "ㄱ"], difficulty: "medium", ageGroup: "4-5세", sampleSentence: "조카가 귀여워요." },
  ...
  { word: "선생님", targetPhonemes: ["ㅅ", "ㄴ", "ㅅ", "ㅇ", "ㄴ", "ㅁ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "선생님이 좋아요." },
  { word: "이웃", targetPhonemes: ["ㅇ", "ㅅ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "이웃이 친절해요." },

  // ── 음악·악기 심화 (Advanced Music) ─────────────────────────────────────
  { word: "피아노", targetPhonemes: ["ㅍ", "ㄴ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "피아노를 쳐요.", soundEffect: "딩동댕" },
  ...
  { word: "클라리넷", targetPhonemes: ["ㄱ", "ㄹ", "ㄴ", "ㅅ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "클라리넷을 불어요." },
  { word: "색소폰", targetPhonemes: ["ㅅ", "ㄱ", "ㅅ", "ㅍ", "ㄴ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "색소폰을 불어요." },
  { word: "트럼펫", targetPhonemes: ["ㅌ", "ㄹ", "ㅁ", "ㅍ", "ㅅ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "트럼펫을 불어요." },
  ...
  { word: "콘트라베이스", targetPhonemes: ["ㄱ", "ㄴ", "ㅌ", "ㄹ", "ㅂ", "ㅅ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "콘트라베이스를 켜요." },
  { word: "실로폰", targetPhonemes: ["ㅅ", "ㄹ", "ㅍ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "실로폰을 쳐요.", soundEffect: "딩딩" },
  { word: "마라카스", targetPhonemes: ["ㅁ", "ㄹ", "ㄱ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "마라카스를 흔들어요.", soundEffect: "샤샤" },
  { word: "캐스터네츠", targetPhonemes: ["ㄱ", "ㅅ", "ㅌ", "ㄴ", "ㅊ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "캐스터네츠를 치요.", soundEffect: "딱딱" },
  { word: "탬버린", targetPhonemes: ["ㅌ", "ㅁ", "ㅂ", "ㄹ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "탬버린을 흔들어요.", soundEffect: "쨍쨍" },
  ...
  { word: "조각", targetPhonemes: ["ㅈ", "ㄱ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "조각을 해요." },
  { word: "점토", targetPhonemes: ["ㅈ", "ㄴ", "ㅌ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "점토로 만들어요." },
  { word: "찰흙", targetPhonemes: ["ㅊ", "ㄹ", "ㅎ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "찰흙으로 빚어요." },
  { word: "콜라주", targetPhonemes: ["ㄱ", "ㄹ", "ㅈ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "콜라주를 만들어요." },
  { word: "데칼코마니", targetPhonemes: ["ㄷ", "ㄱ", "ㄹ", "ㄱ", "ㅁ", "ㄴ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "데칼코마니를 해요." },
  { word: "마블링", targetPhonemes: ["ㅁ", "ㅂ", "ㄹ", "ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "마블링을 해요." },
  { word: "퍼즐", targetPhonemes: ["ㅍ", "ㅈ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "퍼즐을 맞춰요." },
  { word: "레고", targetPhonemes: ["ㄹ", "ㄱ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "레고로 만들어요." },
  { word: "블록", targetPhonemes: ["ㅂ", "ㄹ", "ㄱ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "블록을 쌓아요." },

  // ── 우주·천문 심화 (Advanced Space/Astronomy) ────────────────────────────
  { word: "태양계", targetPhonemes: ["ㅌ", "ㅇ", "ㄱ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "태양계가 넓어요." },
  { word: "은하수", targetPhonemes: ["ㄴ", "ㅎ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "은하수가 아름다워요." },
  { word: "혜성", targetPhonemes: ["ㅎ", "ㅅ", "ㅇ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "혜성이 빛나요." },
  { word: "소행성", targetPhonemes: ["ㅅ", "ㅎ", "ㅇ", "ㅅ", "ㅇ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "소행성이 날아요." },
  { word: "블랙홀", targetPhonemes: ["ㅂ", "ㄹ", "ㄱ", "ㅎ", "ㄹ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "블랙홀이 있어요." },
  { word: "성운", targetPhonemes: ["ㅅ", "ㅇ", "ㄴ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "성운이 아름다워요." },
  { word: "우주선", targetPhonemes: ["ㅅ", "ㅈ", "ㅅ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "우주선이 날아요." },
  { word: "로켓", targetPhonemes: ["ㄹ", "ㄱ", "ㅅ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "로켓이 발사돼요.", soundEffect: "슈욱" },
  { word: "위성", targetPhonemes: ["ㅅ", "ㅇ"], difficulty: "medium", ageGroup: "4-5세", sampleSentence: "위성이 돌아요." },
  { word: "망원경", targetPhonemes: ["ㅁ", "ㅇ", "ㄴ", "ㄱ", "ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "망원경으로 봐요." },
  { word: "천체망원경", targetPhonemes: ["ㅊ", "ㄴ", "ㅊ", "ㅁ", "ㅇ", "ㄴ", "ㄱ", "ㅇ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "천체망원경으로 봐요." },
  { word: "북극성", targetPhonemes: ["ㅂ", "ㄱ", "ㄱ", "ㅅ", "ㅇ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "북극성이 빛나요." },
  { word: "금성", targetPhonemes: ["ㄱ", "ㄴ", "ㅅ", "ㅇ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "금성이 밝아요." },
  ...
  // ── 공룡 (Dinosaurs) ──────────────────────────────────────────────────────
  { word: "공룡", targetPhonemes: ["ㄱ", "ㅇ", "ㄹ", "ㅇ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "공룡이 커요." },
  { word: "티라노사우루스", targetPhonemes: ["ㅌ", "ㄹ", "ㄴ", "ㅅ", "ㄹ", "ㅅ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "티라노사우루스가 무서워요." },
  { word: "트리케라톱스", targetPhonemes: ["ㅌ", "ㄹ", "ㄱ", "ㄹ", "ㅅ", "ㅂ", "ㅅ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "트리케라톱스에게 뿔이 있어요." },
  { word: "브라키오사우루스", targetPhonemes: ["ㅂ", "ㄹ", "ㄱ", "ㅅ", "ㄹ", "ㅅ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "브라키오사우루스 목이 길어요." },
  { word: "스테고사우루스", targetPhonemes: ["ㅅ", "ㅌ", "ㄱ", "ㅅ", "ㄹ", "ㅅ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "스테고사우루스 등에 판이 있어요." },
  { word: "익룡", targetPhonemes: ["ㄱ", "ㄹ", "ㅇ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "익룡이 날아요." },
  { word: "수장룡", targetPhonemes: ["ㅅ", "ㅈ", "ㅇ", "ㄹ", "ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "수장룡이 헤엄쳐요." },
  { word: "화석", targetPhonemes: ["ㅎ", "ㅅ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "화석을 발견해요." },
  { word: "공룡알", targetPhonemes: ["ㄱ", "ㅇ", "ㄹ", "ㅇ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "공룡알을 찾았어요." },
  { word: "뼈", targetPhonemes: ["ㅂ", "ㄴ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "뼈가 있어요." },
  ...
  { word: "점퍼", targetPhonemes: ["ㅈ", "ㄴ", "ㅍ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "점퍼를 입어요." },
  { word: "조끼", targetPhonemes: ["ㅈ", "ㄲ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "조끼를 입어요." },
  { word: "가디건", targetPhonemes: ["ㄱ", "ㄷ", "ㄱ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "가디건을 걸쳐요." },
  ...
  { word: "반바지", targetPhonemes: ["ㅂ", "ㄴ", "ㅂ", "ㅈ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "반바지를 입어요." },
  ...
  { word: "양말", targetPhonemes: ["ㅇ", "ㅁ", "ㄹ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "양말을 신어요." },
  { word: "속옷", targetPhonemes: ["ㅅ", "ㄱ", "ㅅ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "속옷을 입어요." },
  { word: "잠옷", targetPhonemes: ["ㅈ", "ㅁ", "ㅅ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "잠옷을 입어요." },
  ...
  { word: "프라이팬", targetPhonemes: ["ㅍ", "ㄹ", "ㅍ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "프라이팬에 볶아요." },
  { word: "도마", targetPhonemes: ["ㄷ", "ㅁ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "도마 위에 올려요." },
  { word: "국자", targetPhonemes: ["ㄱ", "ㄱ", "ㅈ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "국자로 떠요." },
  { word: "뒤집개", targetPhonemes: ["ㄷ", "ㅈ", "ㄱ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "뒤집개로 뒤집어요." },
  { word: "체", targetPhonemes: ["ㅊ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "체로 걸러요." },
  { word: "믹서기", targetPhonemes: ["ㅁ", "ㄱ", "ㅅ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "믹서기로 갈아요.", soundEffect: "윙윙" },
  { word: "오븐", targetPhonemes: ["ㅂ", "ㄴ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "오븐에 구워요." },
  { word: "전자레인지", targetPhonemes: ["ㅈ", "ㄴ", "ㅈ", "ㄹ", "ㄴ", "ㅈ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "전자레인지에 돌려요." },
  { word: "냉장고", targetPhonemes: ["ㄴ", "ㅇ", "ㅈ", "ㅇ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "냉장고에 넣어요." },
  { word: "식칼", targetPhonemes: ["ㅅ", "ㄱ", "ㄱ", "ㄹ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "식칼로 잘라요." },
  { word: "수저", targetPhonemes: ["ㅅ", "ㅈ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "수저로 먹어요." },
  { word: "젓가락", targetPhonemes: ["ㅈ", "ㅅ", "ㄱ", "ㄹ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "젓가락으로 집어요." },
  { word: "포크", targetPhonemes: ["ㅍ", "ㄱ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "포크로 찍어요." },
  { word: "숟가락", targetPhonemes: ["ㅅ", "ㄷ", "ㄱ", "ㄹ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "숟가락으로 떠요." },
  ...
  { word: "컵", targetPhonemes: ["ㄱ", "ㅂ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "컵에 따라요." },
  { word: "머그컵", targetPhonemes: ["ㅁ", "ㄱ", "ㄱ", "ㅂ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "머그컵에 마셔요." },
  { word: "냄비받침", targetPhonemes: ["ㄴ", "ㅁ", "ㅂ", "ㄹ", "ㅊ", "ㅁ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "냄비받침 위에 올려요." },

  // ── 파티·행사 (Party/Events) ──────────────────────────────────────────────
  { word: "생일", targetPhonemes: ["ㅅ", "ㅇ", "ㄴ", "ㄹ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "생일 축하해요." },
  { word: "생일파티", targetPhonemes: ["ㅅ", "ㅇ", "ㄴ", "ㄹ", "ㅍ", "ㅌ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "생일파티를 해요." },
  { word: "초대장", targetPhonemes: ["ㅊ", "ㄷ", "ㅈ", "ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "초대장을 써요." },
  { word: "선물", targetPhonemes: ["ㅅ", "ㄴ", "ㄹ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "선물을 받아요." },
  { word: "포장지", targetPhonemes: ["ㅍ", "ㅈ", "ㅇ", "ㅈ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "포장지로 싸요." },
  ...
  { word: "폭죽", targetPhonemes: ["ㅍ", "ㄱ", "ㅈ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "폭죽이 터져요.", soundEffect: "펑" },
  { word: "촛불", targetPhonemes: ["ㅊ", "ㅅ", "ㅂ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "촛불을 불어요." },
  { word: "축하", targetPhonemes: ["ㅊ", "ㄱ", "ㅎ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "축하해요." },
  { word: "졸업", targetPhonemes: ["ㅈ", "ㄹ", "ㄱ", "ㅂ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "졸업을 축하해요." },
  { word: "입학", targetPhonemes: ["ㅂ", "ㄱ", "ㅎ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "입학을 축하해요." },
  { word: "운동회", targetPhonemes: ["ㄴ", "ㄷ", "ㅇ", "ㅎ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "운동회가 재미있어요." },
  { word: "발표회", targetPhonemes: ["ㅂ", "ㄹ", "ㅍ", "ㅇ", "ㅎ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "발표회에서 춰요." },
  { word: "크리스마스", targetPhonemes: ["ㄱ", "ㄹ", "ㅅ", "ㅁ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "크리스마스가 좋아요." },

  // ── 동화·판타지 심화 (Advanced Fairy Tale) ───────────────────────────────
  { word: "마법봉", targetPhonemes: ["ㅁ", "ㅂ", "ㅂ", "ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "마법봉을 흔들어요." },
  { word: "투명망토", targetPhonemes: ["ㅌ", "ㅁ", "ㅇ", "ㄴ", "ㅌ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "투명망토를 입어요." },
  { word: "빗자루", targetPhonemes: ["ㅂ", "ㅅ", "ㅈ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "마녀가 빗자루를 타요." },
  { word: "수정구슬", targetPhonemes: ["ㅅ", "ㅈ", "ㅇ", "ㄱ", "ㅅ", "ㄹ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "수정구슬이 빛나요." },
  { word: "요술램프", targetPhonemes: ["ㄹ", "ㅅ", "ㄹ", "ㅁ", "ㅍ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "요술램프를 문질러요." },
  ...
  { word: "저주", targetPhonemes: ["ㅈ", "ㅈ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "저주를 풀어요." },
  { word: "유니콘", targetPhonemes: ["ㄴ", "ㄱ", "ㄴ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "유니콘이 날아요." },
  { word: "인어공주", targetPhonemes: ["ㄴ", "ㄱ", "ㅇ", "ㅈ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "인어공주가 헤엄쳐요." },
  { word: "피노키오", targetPhonemes: ["ㅍ", "ㄴ", "ㄱ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "피노키오 코가 길어요." },
  { word: "빨간모자", targetPhonemes: ["ㅃ", "ㄹ", "ㄱ", "ㄴ", "ㅁ", "ㅈ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "빨간모자가 걸어요." },
  { word: "신데렐라", targetPhonemes: ["ㅅ", "ㄴ", "ㄷ", "ㄹ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "신데렐라가 예뻐요." },
  { word: "백설공주", targetPhonemes: ["ㅂ", "ㄱ", "ㅅ", "ㄹ", "ㄱ", "ㅇ", "ㅈ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "백설공주가 일어나요." },
  ...
  { word: "프로그래머", targetPhonemes: ["ㅍ", "ㄹ", "ㄱ", "ㄹ", "ㅁ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "프로그래머가 코딩해요." },
  { word: "디자이너", targetPhonemes: ["ㄷ", "ㅈ", "ㄴ"], difficulty: "medium", ageGroup: "4-5세", sampleSentence: "디자이너가 만들어요." },
  { word: "영양사", targetPhonemes: ["ㅇ", "ㄴ", "ㅅ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "영양사가 식단을 짜요." },
  { word: "사진사", targetPhonemes: ["ㅅ", "ㅈ", "ㄴ", "ㅅ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "사진사가 찍어요." },
  { word: "마술사", targetPhonemes: ["ㅁ", "ㅅ", "ㄹ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "마술사가 마술을 해요." },
  { word: "환경미화원", targetPhonemes: ["ㅎ", "ㄴ", "ㄱ", "ㅁ", "ㅎ", "ㄴ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "환경미화원이 청소해요." },
  { word: "배우", targetPhonemes: ["ㅂ", "ㅇ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "배우가 연기해요." },
  ...
  { word: "만화가", targetPhonemes: ["ㅁ", "ㄴ", "ㅎ", "ㄱ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "만화가가 만화를 그려요." },
  { word: "요리사", targetPhonemes: ["ㄹ", "ㅅ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "요리사가 요리해요." },
  { word: "제빵사", targetPhonemes: ["ㅈ", "ㅂ", "ㅇ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "제빵사가 빵을 구워요." },

  // ── 환경·지구 (Environment/Earth) ────────────────────────────────────────
  { word: "재활용", targetPhonemes: ["ㅈ", "ㅎ", "ㄹ", "ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "재활용을 해요." },
  { word: "분리수거", targetPhonemes: ["ㅂ", "ㄴ", "ㄹ", "ㅅ", "ㄱ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "분리수거를 해요." },
  { word: "쓰레기", targetPhonemes: ["ㅆ", "ㄹ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "쓰레기를 버려요." },
  { word: "쓰레기통", targetPhonemes: ["ㅆ", "ㄹ", "ㄱ", "ㅌ", "ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "쓰레기통에 버려요." },
  { word: "지구온난화", targetPhonemes: ["ㅈ", "ㄱ", "ㄴ", "ㄴ", "ㅎ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "지구온난화가 심해요." },
  { word: "태양광", targetPhonemes: ["ㅌ", "ㅇ", "ㄱ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "태양광 에너지를 써요." },
  { word: "풍력", targetPhonemes: ["ㅍ", "ㅇ", "ㄹ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "풍력 에너지를 써요." },
  { word: "나무심기", targetPhonemes: ["ㄴ", "ㅁ", "ㅅ", "ㅁ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "나무심기를 해요." },
  { word: "텃밭", targetPhonemes: ["ㅌ", "ㅅ", "ㅂ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "텃밭에 채소를 심어요." },
  ...
  { word: "더하기", targetPhonemes: ["ㄷ", "ㅎ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "더하기를 해요." },
  { word: "빼기", targetPhonemes: ["ㅃ", "ㄱ"], difficulty: "medium", ageGroup: "4-5세", sampleSentence: "빼기를 해요." },
  { word: "곱하기", targetPhonemes: ["ㄱ", "ㅂ", "ㅎ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "곱하기를 해요." },
  { word: "나누기", targetPhonemes: ["ㄴ", "ㄴ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "나누기를 해요." },
  { word: "같다", targetPhonemes: ["ㄱ", "ㅅ", "ㄷ"], difficulty: "medium", ageGroup: "4-5세", sampleSentence: "같아요." },
  { word: "다르다", targetPhonemes: ["ㄷ", "ㄹ", "ㄷ"], difficulty: "medium", ageGroup: "4-5세", sampleSentence: "달라요." },
  ...
  { word: "석고붕대", targetPhonemes: ["ㅅ", "ㄱ", "ㄱ", "ㅂ", "ㅇ", "ㄷ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "석고붕대를 해요." },
  { word: "수술", targetPhonemes: ["ㅅ", "ㅅ", "ㄹ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "수술을 해요." },
  ...
  { word: "퇴원", targetPhonemes: ["ㅌ", "ㅇ", "ㄴ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "퇴원을 해요." },
  ...
  { word: "술래잡기", targetPhonemes: ["ㅅ", "ㄹ", "ㄹ", "ㅈ", "ㅂ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "술래잡기를 해요." },
  { word: "오징어게임", targetPhonemes: ["ㅈ", "ㅇ", "ㄱ", "ㄱ", "ㅁ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "오징어게임을 해요." },
  { word: "달팽이게임", targetPhonemes: ["ㄷ", "ㄹ", "ㅍ", "ㄴ", "ㄱ", "ㄱ", "ㅁ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "달팽이게임을 해요." },
  { word: "무궁화꽃이피었습니다", targetPhonemes: ["ㅁ", "ㄱ", "ㅎ", "ㄲ", "ㅊ", "ㅍ", "ㅇ", "ㅅ", "ㄴ", "ㄷ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "무궁화꽃이 피었습니다!" },
  { word: "가위바위보", targetPhonemes: ["ㄱ", "ㅂ", "ㅂ", "ㅇ", "ㅂ"], difficulty: "hard", ageGroup: "3-4세", sampleSentence: "가위바위보를 해요." },
  { word: "제기차기", targetPhonemes: ["ㅈ", "ㄱ", "ㅊ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "제기차기를 해요." },
  { word: "딱지치기", targetPhonemes: ["ㄸ", "ㄱ", "ㅈ", "ㅊ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "딱지치기를 해요." },
  { word: "구슬치기", targetPhonemes: ["ㄱ", "ㅅ", "ㄹ", "ㅊ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "구슬치기를 해요." },
  { word: "고무줄넘기", targetPhonemes: ["ㄱ", "ㅁ", "ㅈ", "ㄹ", "ㄴ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "고무줄넘기를 해요." },
  ...
  { word: "카드게임", targetPhonemes: ["ㄱ", "ㄷ", "ㄱ", "ㅁ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "카드게임을 해요." },

  // ── 자연·식물 심화 (Advanced Plants/Nature) ───────────────────────────────
  { word: "소나무", targetPhonemes: ["ㅅ", "ㄴ", "ㅁ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "소나무가 초록이에요." },
  { word: "단풍나무", targetPhonemes: ["ㄷ", "ㄴ", "ㅍ", "ㄴ", "ㅁ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "단풍나무가 빨개요." },
  { word: "은행나무", targetPhonemes: ["ㄴ", "ㅎ", "ㄴ", "ㄴ", "ㅁ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "은행나무 잎이 노래요." },
  { word: "수국", targetPhonemes: ["ㅅ", "ㄱ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "수국이 예뻐요." },
  { word: "해바라기", targetPhonemes: ["ㅎ", "ㅂ", "ㄹ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "해바라기가 활짝 피었어요." },
  { word: "코스모스", targetPhonemes: ["ㄱ", "ㅅ", "ㅁ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "코스모스가 예뻐요." },
  { word: "라일락", targetPhonemes: ["ㄹ", "ㄹ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "라일락 향기가 좋아요." },
  ...
  { word: "연꽃", targetPhonemes: ["ㄹ", "ㄴ", "ㄲ", "ㅊ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "연꽃이 아름다워요." },
  { word: "씨앗", targetPhonemes: ["ㅆ", "ㅅ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "씨앗을 심어요." },
  { word: "싹", targetPhonemes: ["ㅆ", "ㄱ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "싹이 났어요." },
  { word: "뿌리", targetPhonemes: ["ㅃ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "뿌리가 있어요." },
  { word: "줄기", targetPhonemes: ["ㅈ", "ㄹ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "줄기가 길어요." },
  { word: "꽃잎", targetPhonemes: ["ㄲ", "ㅊ", "ㄴ", "ㅂ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "꽃잎이 예뻐요." },
  ...
  { word: "가뭄", targetPhonemes: ["ㄱ", "ㅁ", "ㅁ"], difficulty: "medium", ageGroup: "4-5세", sampleSentence: "가뭄이 들었어요." },
  { word: "폭염", targetPhonemes: ["ㅍ", "ㄱ", "ㄴ", "ㅁ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "폭염이 심해요." },
  ...
  { word: "기압", targetPhonemes: ["ㄱ", "ㅇ", "ㄱ", "ㅂ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "기압이 변해요." },
  { word: "무더위", targetPhonemes: ["ㅁ", "ㄷ", "ㅇ"], difficulty: "medium", ageGroup: "4-5세", sampleSentence: "무더위가 심해요." },
  { word: "꽃샘추위", targetPhonemes: ["ㄲ", "ㅊ", "ㅅ", "ㅁ", "ㅊ", "ㅇ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "꽃샘추위가 왔어요." },
  { word: "온도", targetPhonemes: ["ㄴ", "ㄷ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "온도를 재요." },
  { word: "기상예보", targetPhonemes: ["ㄱ", "ㅅ", "ㅇ", "ㅂ", "ㅇ", "ㅂ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "기상예보를 봐요." },
  { word: "태풍경보", targetPhonemes: ["ㅌ", "ㅍ", "ㄱ", "ㄱ", "ㅂ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "태풍경보가 울려요." },

  // ── 동작·움직임 심화 (Advanced Actions) ─────────────────────────────────
  { word: "뛰어오르다", targetPhonemes: ["ㄷ", "ㄹ", "ㅇ", "ㄷ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "뛰어올라요." },
  { word: "구르다", targetPhonemes: ["ㄱ", "ㄹ", "ㄷ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "데굴데굴 굴러요." },
  { word: "미끄러지다", targetPhonemes: ["ㅁ", "ㄲ", "ㄹ", "ㅈ", "ㄷ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "미끄러져요." },
  { word: "넘어지다", targetPhonemes: ["ㄴ", "ㅁ", "ㄹ", "ㅈ", "ㄷ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "넘어졌어요." },
  { word: "기어가다", targetPhonemes: ["ㄱ", "ㄱ", "ㄷ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "기어가요." },
  { word: "날아가다", targetPhonemes: ["ㄴ", "ㄹ", "ㄱ", "ㄷ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "날아가요." },
  { word: "헤엄치다", targetPhonemes: ["ㅎ", "ㅇ", "ㅁ", "ㅊ", "ㄷ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "헤엄쳐요." },
  { word: "파닥파닥", targetPhonemes: ["ㅍ", "ㄷ", "ㄱ", "ㅍ", "ㄷ", "ㄱ"], difficulty: "hard", ageGroup: "3-4세", sampleSentence: "새가 파닥파닥 날아요.", soundEffect: "파닥파닥" },
  { word: "빙글빙글", targetPhonemes: ["ㅂ", "ㅇ", "ㄱ", "ㄹ", "ㅂ", "ㅇ", "ㄱ", "ㄹ"], difficulty: "hard", ageGroup: "3-4세", sampleSentence: "빙글빙글 돌아요.", soundEffect: "빙글빙글" },
  { word: "끄덕끄덕", targetPhonemes: ["ㄲ", "ㄷ", "ㄱ", "ㄲ", "ㄷ", "ㄱ"], difficulty: "hard", ageGroup: "3-4세", sampleSentence: "끄덕끄덕 고개를 끄덕여요.", soundEffect: "끄덕끄덕" },
  { word: "고개젓다", targetPhonemes: ["ㄱ", "ㄱ", "ㅈ", "ㅅ", "ㄷ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "고개를 저어요." },
  { word: "손흔들다", targetPhonemes: ["ㅅ", "ㄴ", "ㅎ", "ㄴ", "ㄷ", "ㄹ", "ㄷ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "손을 흔들어요." },
  { word: "안아주다", targetPhonemes: ["ㄴ", "ㅈ", "ㄷ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "안아줘요." },
  { word: "토닥토닥", targetPhonemes: ["ㅌ", "ㄷ", "ㄱ", "ㅌ", "ㄷ", "ㄱ"], difficulty: "hard", ageGroup: "3-4세", sampleSentence: "토닥토닥 두드려요.", soundEffect: "토닥토닥" },

  // ── 크기·양·비교 (Size/Amount/Comparison) ────────────────────────────────
  { word: "조금씩", targetPhonemes: ["ㅈ", "ㄱ", "ㅁ", "ㅆ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "조금씩 먹어요." },
  { word: "가득", targetPhonemes: ["ㄱ", "ㄷ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "가득 차요." },
  { word: "텅텅", targetPhonemes: ["ㅌ", "ㅇ", "ㅌ", "ㅇ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "텅텅 비었어요.", soundEffect: "텅텅" },
  ...
  { word: "빨리", targetPhonemes: ["ㅃ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "빨리 해요." },
  { word: "함께", targetPhonemes: ["ㅎ", "ㅁ", "ㄲ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "함께 해요." },

  // ── 감각·느낌 (Senses/Feelings) ──────────────────────────────────────────
  { word: "따뜻해요", targetPhonemes: ["ㄷ", "ㄷ", "ㄷ", "ㅅ", "ㅎ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "따뜻해요." },
  { word: "차가워요", targetPhonemes: ["ㅊ", "ㄱ", "ㅇ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "차가워요." },
  { word: "뜨거워요", targetPhonemes: ["ㄷ", "ㄱ", "ㅇ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "뜨거워요." },
  { word: "시원해요", targetPhonemes: ["ㅅ", "ㅇ", "ㄴ", "ㅎ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "시원해요." },
  { word: "딱딱해요", targetPhonemes: ["ㄸ", "ㄱ", "ㄸ", "ㄱ", "ㅎ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "딱딱해요." },
  { word: "말랑말랑", targetPhonemes: ["ㅁ", "ㄹ", "ㅇ", "ㅁ", "ㄹ", "ㅇ"], difficulty: "hard", ageGroup: "3-4세", sampleSentence: "말랑말랑해요.", soundEffect: "말랑말랑" },
  { word: "보들보들", targetPhonemes: ["ㅂ", "ㄷ", "ㄹ", "ㅂ", "ㄷ", "ㄹ"], difficulty: "hard", ageGroup: "3-4세", sampleSentence: "보들보들해요.", soundEffect: "보들보들" },
  { word: "거칠거칠", targetPhonemes: ["ㄱ", "ㅊ", "ㄹ", "ㄱ", "ㅊ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "거칠거칠해요.", soundEffect: "거칠거칠" },
  { word: "미끌미끌", targetPhonemes: ["ㅁ", "ㄲ", "ㄹ", "ㅁ", "ㄲ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "미끌미끌해요.", soundEffect: "미끌미끌" },
  { word: "향기롭다", targetPhonemes: ["ㅎ", "ㅇ", "ㄱ", "ㄹ", "ㅂ", "ㄷ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "향기로워요." },
  { word: "냄새나요", targetPhonemes: ["ㄴ", "ㅁ", "ㅅ", "ㄴ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "냄새나요." },
  { word: "소리나요", targetPhonemes: ["ㅅ", "ㄹ", "ㄴ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "소리나요." },
  { word: "맛없어요", targetPhonemes: ["ㅁ", "ㅅ", "ㅂ", "ㅅ", "ㅇ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "맛없어요." },
  { word: "신맛", targetPhonemes: ["ㅅ", "ㄴ", "ㅁ", "ㅅ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "신맛이 나요." },
  ...
  { word: "매운맛", targetPhonemes: ["ㅁ", "ㄴ", "ㅁ", "ㅅ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "매운맛이 나요." },

  // ── 수학·도형 (Math/Shapes) ───────────────────────────────────────────────
  { word: "삼각형", targetPhonemes: ["ㅅ", "ㅁ", "ㄱ", "ㄱ", "ㅎ", "ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "삼각형을 그려요." },
  { word: "사각형", targetPhonemes: ["ㅅ", "ㄱ", "ㄱ", "ㅎ", "ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "사각형을 그려요." },
  { word: "원", targetPhonemes: ["ㄴ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "원을 그려요." },
  { word: "육각형", targetPhonemes: ["ㄱ", "ㄱ", "ㅎ", "ㅇ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "육각형을 그려요." },
  ...
  { word: "순서", targetPhonemes: ["ㅅ", "ㄴ", "ㅅ"], difficulty: "medium", ageGroup: "4-5세", sampleSentence: "순서대로 해요." },
  { word: "분류", targetPhonemes: ["ㅂ", "ㄴ", "ㄹ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "분류해요." },
  { word: "비교", targetPhonemes: ["ㅂ", "ㄱ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "비교해요." },

  // ── 언어·읽기 (Language/Reading) ─────────────────────────────────────────
  { word: "글자", targetPhonemes: ["ㄱ", "ㄹ", "ㅈ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "글자를 읽어요." },
  { word: "단어", targetPhonemes: ["ㄷ", "ㄴ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "단어를 배워요." },
  { word: "문장", targetPhonemes: ["ㅁ", "ㄴ", "ㅈ", "ㅇ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "문장을 읽어요." },
  { word: "동화책", targetPhonemes: ["ㄷ", "ㅎ", "ㅊ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "동화책을 읽어요." },
  { word: "그림책", targetPhonemes: ["ㄱ", "ㄹ", "ㅁ", "ㅊ", "ㄱ"], difficulty: "hard", ageGroup: "3-4세", sampleSentence: "그림책이 재미있어요." },
  ...
  { word: "수수께끼", targetPhonemes: ["ㅅ", "ㅅ", "ㄲ", "ㄲ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "수수께끼를 맞춰요." },
  { word: "받아쓰기", targetPhonemes: ["ㅂ", "ㄷ", "ㅆ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "받아쓰기를 해요." },
  { word: "소리내어읽기", targetPhonemes: ["ㅅ", "ㄹ", "ㄴ", "ㄹ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "소리내어 읽어요." },

  // ── 집안일·청소 (Household Chores) ───────────────────────────────────────
  { word: "청소", targetPhonemes: ["ㅊ", "ㅇ", "ㅅ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "청소를 해요." },
  { word: "빨래", targetPhonemes: ["ㅃ", "ㄹ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "빨래를 해요." },
  ...
  { word: "다림질", targetPhonemes: ["ㄷ", "ㄹ", "ㅁ", "ㅈ", "ㄹ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "다림질을 해요." },
  ...
  { word: "닦다", targetPhonemes: ["ㄷ", "ㄱ", "ㄷ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "걸레로 닦아요." },
  { word: "버리다", targetPhonemes: ["ㅂ", "ㄹ", "ㄷ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "쓰레기를 버려요." },

  // ── 안전·규칙 (Safety/Rules) ──────────────────────────────────────────────
  { word: "안전벨트", targetPhonemes: ["ㄴ", "ㅈ", "ㄴ", "ㅂ", "ㄹ", "ㅌ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "안전벨트를 해요." },
  { word: "신호등", targetPhonemes: ["ㅅ", "ㄴ", "ㅎ", "ㄷ", "ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "신호등을 지켜요." },
  { word: "횡단보도", targetPhonemes: ["ㅎ", "ㅇ", "ㄷ", "ㄴ", "ㅂ", "ㄷ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "횡단보도를 건너요." },
  { word: "안전모", targetPhonemes: ["ㄴ", "ㅈ", "ㄴ", "ㅁ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "안전모를 써요." },
  ...
  { word: "규칙", targetPhonemes: ["ㄱ", "ㄱ", "ㄱ"], difficulty: "medium", ageGroup: "4-5세", sampleSentence: "규칙을 지켜요." },
  { word: "약속", targetPhonemes: ["ㄱ", "ㅅ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "약속을 지켜요." },
  { word: "조심", targetPhonemes: ["ㅈ", "ㅅ", "ㅁ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "조심해요." },

  // ── 과학·실험 (Science/Experiments) ──────────────────────────────────────
  { word: "실험", targetPhonemes: ["ㅅ", "ㄹ", "ㄱ", "ㅁ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "실험을 해요." },
  { word: "현미경", targetPhonemes: ["ㅎ", "ㄴ", "ㅁ", "ㄱ", "ㄱ", "ㅇ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "현미경으로 봐요." },
  { word: "자석", targetPhonemes: ["ㅈ", "ㅅ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "자석이 붙어요." },
  { word: "전기", targetPhonemes: ["ㅈ", "ㄴ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "전기가 흘러요." },
  { word: "물질", targetPhonemes: ["ㅁ", "ㄹ", "ㅈ", "ㄹ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "물질을 관찰해요." },
  ...
  { word: "비교실험", targetPhonemes: ["ㅂ", "ㄱ", "ㅅ", "ㄹ", "ㄱ", "ㅁ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "비교실험을 해요." },
  ...
  { word: "단독주택", targetPhonemes: ["ㄷ", "ㄴ", "ㄷ", "ㅈ", "ㅌ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "단독주택에 살아요." },
  { word: "엘리베이터", targetPhonemes: ["ㄹ", "ㅂ", "ㅌ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "엘리베이터를 타요." },
  { word: "계단", targetPhonemes: ["ㄱ", "ㄷ", "ㄴ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "계단을 올라가요." },
  { word: "난간", targetPhonemes: ["ㄴ", "ㄴ", "ㄱ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "난간을 잡아요." },
  { word: "복도", targetPhonemes: ["ㅂ", "ㄱ", "ㄷ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "복도를 걸어요." },
  { word: "현관", targetPhonemes: ["ㅎ", "ㄴ", "ㄱ", "ㄴ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "현관에서 신발을 신어요." },
  { word: "울타리", targetPhonemes: ["ㄹ", "ㅌ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "울타리가 있어요." },
  { word: "지붕", targetPhonemes: ["ㅈ", "ㅂ", "ㅇ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "지붕이 있어요." },
  { word: "굴뚝", targetPhonemes: ["ㄱ", "ㄹ", "ㄷ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "굴뚝에서 연기가 나요." },
  { word: "다리", targetPhonemes: ["ㄷ", "ㄹ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "다리를 건너요." },
  { word: "터널", targetPhonemes: ["ㅌ", "ㄴ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "터널을 통과해요." },
  { word: "댐", targetPhonemes: ["ㄷ", "ㅁ"], difficulty: "medium", ageGroup: "4-5세", sampleSentence: "댐에 물이 있어요." },
  { word: "탑", targetPhonemes: ["ㅌ", "ㅂ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "탑이 높아요." },

  // ── 바다·해양 (Ocean/Marine) ──────────────────────────────────────────────
  { word: "파도", targetPhonemes: ["ㅍ", "ㄷ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "파도가 쳐요.", soundEffect: "철썩" },
  { word: "모래사장", targetPhonemes: ["ㅁ", "ㄹ", "ㅅ", "ㅈ", "ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "모래사장에서 놀아요." },
  { word: "조개", targetPhonemes: ["ㅈ", "ㄱ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "조개를 주워요." },
  ...
  { word: "불가사리", targetPhonemes: ["ㅂ", "ㄹ", "ㄱ", "ㅅ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "불가사리가 예뻐요." },
  { word: "게", targetPhonemes: ["ㄱ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "게가 옆으로 걸어요." },
  { word: "새우", targetPhonemes: ["ㅅ", "ㅇ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "새우가 맛있어요." },
  { word: "문어", targetPhonemes: ["ㅁ", "ㄴ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "문어 다리가 여덟 개예요." },
  ...
  { word: "해파리", targetPhonemes: ["ㅎ", "ㅍ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "해파리가 투명해요." },
  ...
  { word: "스노클링", targetPhonemes: ["ㅅ", "ㄴ", "ㄱ", "ㄹ", "ㅇ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "스노클링을 해요." },

  // ── 농장·시골 (Farm/Country) ──────────────────────────────────────────────
  { word: "농장", targetPhonemes: ["ㄴ", "ㅇ", "ㅈ", "ㅇ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "농장에 가요." },
  { word: "논", targetPhonemes: ["ㄴ", "ㄴ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "논에 벼가 자라요." },
  { word: "밭", targetPhonemes: ["ㅂ", "ㅅ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "밭에 채소가 자라요." },
  { word: "벼", targetPhonemes: ["ㅂ", "ㄴ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "벼가 황금색이에요." },
  { word: "허수아비", targetPhonemes: ["ㅎ", "ㅅ", "ㅂ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "허수아비가 있어요." },
  { word: "트랙터", targetPhonemes: ["ㅌ", "ㄹ", "ㄱ", "ㅌ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "트랙터가 밭을 갈아요." },
  ...
  { word: "닭장", targetPhonemes: ["ㄷ", "ㄱ", "ㅈ", "ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "닭장에 닭이 있어요." },
  { word: "외양간", targetPhonemes: ["ㅇ", "ㅇ", "ㄱ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "외양간에 소가 있어요." },

  // ── 표현·감탄사 (Expressions/Interjections) ──────────────────────────────
  { word: "앗따", targetPhonemes: ["ㅅ", "ㄷ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "앗따, 맛있다!", soundEffect: "앗따" },
  { word: "어머나", targetPhonemes: ["ㅁ", "ㄴ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "어머나, 예쁘다!", soundEffect: "어머나" },
  { word: "짝짝짝", targetPhonemes: ["ㅉ", "ㄱ", "ㅉ", "ㄱ", "ㅉ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "짝짝짝, 잘했어요!", soundEffect: "짝짝짝" },
  { word: "맞아요", targetPhonemes: ["ㅁ", "ㅈ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "맞아요." },
  { word: "틀려요", targetPhonemes: ["ㅌ", "ㄹ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "틀려요." },
  { word: "몰라요", targetPhonemes: ["ㅁ", "ㄹ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "몰라요." },
  { word: "왜냐면", targetPhonemes: ["ㅇ", "ㄴ", "ㄴ", "ㅁ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "왜냐면이요." },
  ...
  { word: "손가락질", targetPhonemes: ["ㅅ", "ㄴ", "ㄱ", "ㄹ", "ㅈ", "ㄹ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "손가락질하지 않아요." },
  { word: "코풀기", targetPhonemes: ["ㄱ", "ㅍ", "ㄹ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "코를 풀어요." },
  { word: "손톱깎기", targetPhonemes: ["ㅅ", "ㄴ", "ㅌ", "ㅂ", "ㄲ", "ㄱ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "손톱을 깎아요." },
  { word: "머리감기", targetPhonemes: ["ㅁ", "ㄹ", "ㄱ", "ㅁ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "머리를 감아요." },
  { word: "칫솔", targetPhonemes: ["ㅊ", "ㅅ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "칫솔로 닦아요." },
  { word: "치약", targetPhonemes: ["ㅊ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "치약을 짜요." },
  ...
  { word: "손소독제", targetPhonemes: ["ㅅ", "ㄴ", "ㅅ", "ㄷ", "ㄱ", "ㅈ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "손소독제를 발라요." },
  { word: "마스크", targetPhonemes: ["ㅁ", "ㅅ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "마스크를 써요." },

  // ── 미디어·엔터테인먼트 (Media/Entertainment) ─────────────────────────────
  { word: "만화", targetPhonemes: ["ㅁ", "ㄴ", "ㅎ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "만화를 봐요." },
  { word: "애니메이션", targetPhonemes: ["ㄴ", "ㅁ", "ㅇ", "ㅅ", "ㄴ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "애니메이션이 재미있어요." },
  { word: "영화", targetPhonemes: ["ㅇ", "ㄴ", "ㅎ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "영화를 봐요." },
  ...
  { word: "라디오", targetPhonemes: ["ㄹ", "ㄷ", "ㄱ"], difficulty: "easy", ageGroup: "2-3세", sampleSentence: "라디오를 들어요." },
  { word: "음악방송", targetPhonemes: ["ㅇ", "ㅁ", "ㄱ", "ㅂ", "ㅅ", "ㅇ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "음악방송을 봐요." },
  { word: "뉴스", targetPhonemes: ["ㄴ", "ㅅ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "뉴스를 봐요." },
  { word: "콘서트", targetPhonemes: ["ㄱ", "ㄴ", "ㅅ", "ㅌ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "콘서트에 가요." },
  { word: "뮤지컬", targetPhonemes: ["ㅁ", "ㅈ", "ㄱ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "뮤지컬을 봐요." },
  { word: "연극", targetPhonemes: ["ㄴ", "ㄱ", "ㄱ"], difficulty: "medium", ageGroup: "4-5세", sampleSentence: "연극을 봐요." },
  ...
  { word: "쌍둥이", targetPhonemes: ["ㅆ", "ㅇ", "ㄷ", "ㅇ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "쌍둥이가 닮았어요." },
  ...
  { word: "씩씩해요", targetPhonemes: ["ㅆ", "ㄱ", "ㅆ", "ㄱ", "ㅎ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "씩씩해요." },
  { word: "뚝뚝", targetPhonemes: ["ㄸ", "ㄱ", "ㄸ", "ㄱ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "물이 뚝뚝 떨어져요.", soundEffect: "뚝뚝" },
  ...
  { word: "쑤셔요", targetPhonemes: ["ㅆ", "ㅅ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "머리가 쑤셔요." },
  { word: "뻣뻣해요", targetPhonemes: ["ㅃ", "ㅅ", "ㅃ", "ㅅ", "ㅎ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "뻣뻣해요." },
  { word: "따분해요", targetPhonemes: ["ㄸ", "ㅂ", "ㄴ", "ㅎ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "따분해요." },
  { word: "쓸쓸해요", targetPhonemes: ["ㅆ", "ㄹ", "ㅆ", "ㄹ", "ㅎ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "쓸쓸해요." },
  { word: "뿌듯해요", targetPhonemes: ["ㅃ", "ㄷ", "ㄷ", "ㅅ", "ㅎ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "뿌듯해요." },
  ...
  { word: "뚱뚱해요", targetPhonemes: ["ㄸ", "ㅇ", "ㄸ", "ㅇ", "ㅎ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "뚱뚱해요." },
  { word: "까칠해요", targetPhonemes: ["ㄲ", "ㅊ", "ㄹ", "ㅎ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "까칠해요." },
  { word: "찌릿찌릿", targetPhonemes: ["ㅉ", "ㄹ", "ㅅ", "ㅉ", "ㄹ", "ㅅ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "찌릿찌릿해요.", soundEffect: "찌릿찌릿" },
  { word: "으쓱으쓱", targetPhonemes: ["ㅆ", "ㄱ", "ㅆ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "으쓱으쓱해요.", soundEffect: "으쓱으쓱" },
  { word: "펄떡펄떡", targetPhonemes: ["ㅍ", "ㄹ", "ㄸ", "ㄱ", "ㅍ", "ㄹ", "ㄸ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "물고기가 펄떡펄떡해요.", soundEffect: "펄떡펄떡" },
  { word: "꼬불꼬불", targetPhonemes: ["ㄲ", "ㅂ", "ㄹ", "ㄲ", "ㅂ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "꼬불꼬불 라면이에요.", soundEffect: "꼬불꼬불" },
  { word: "따르릉", targetPhonemes: ["ㄸ", "ㄹ", "ㄹ", "ㅇ"], difficulty: "hard", ageGroup: "3-4세", sampleSentence: "전화가 따르릉 울려요.", soundEffect: "따르릉" },
  { word: "쨍그랑", targetPhonemes: ["ㅉ", "ㅇ", "ㄱ", "ㄹ", "ㅇ"], difficulty: "hard", ageGroup: "3-4세", sampleSentence: "유리가 쨍그랑 소리나요.", soundEffect: "쨍그랑" },
  { word: "삐걱삐걱", targetPhonemes: ["ㅃ", "ㄱ", "ㅃ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "문이 삐걱삐걱해요.", soundEffect: "삐걱삐걱" },
  { word: "쿨쿨", targetPhonemes: ["ㄱ", "ㄹ", "ㄱ", "ㄹ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "쿨쿨 자요.", soundEffect: "쿨쿨" },
  { word: "찰싹", targetPhonemes: ["ㅊ", "ㄹ", "ㅆ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "찰싹 때려요.", soundEffect: "찰싹" },
  { word: "뚝딱뚝딱", targetPhonemes: ["ㄸ", "ㄱ", "ㄸ", "ㄱ", "ㄸ", "ㄱ", "ㄸ", "ㄱ"], difficulty: "hard", ageGroup: "3-4세", sampleSentence: "뚝딱뚝딱 만들어요.", soundEffect: "뚝딱뚝딱" },
  { word: "쏴아", targetPhonemes: ["ㅆ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "물이 쏴아 흘러요.", soundEffect: "쏴아" },
  { word: "쫄쫄", targetPhonemes: ["ㅉ", "ㄹ", "ㅉ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "물이 쫄쫄 흘러요.", soundEffect: "쫄쫄" },
  { word: "폭신폭신", targetPhonemes: ["ㅍ", "ㄱ", "ㅅ", "ㄴ", "ㅍ", "ㄱ", "ㅅ", "ㄴ"], difficulty: "hard", ageGroup: "3-4세", sampleSentence: "폭신폭신해요.", soundEffect: "폭신폭신" },
  { word: "뾰족뾰족", targetPhonemes: ["ㅂ", "ㅃ", "ㅈ", "ㄱ", "ㅂ", "ㅃ", "ㅈ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "뾰족뾰족해요." },
  { word: "삐뚤삐뚤", targetPhonemes: ["ㅃ", "ㄷ", "ㄹ", "ㅃ", "ㄷ", "ㄹ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "삐뚤삐뚤 써요.", soundEffect: "삐뚤삐뚤" },
  { word: "쏙쏙", targetPhonemes: ["ㅆ", "ㄱ", "ㅆ", "ㄱ"], difficulty: "hard", ageGroup: "3-4세", sampleSentence: "쏙쏙 들어가요.", soundEffect: "쏙쏙" },
  { word: "뚝배기", targetPhonemes: ["ㄸ", "ㄱ", "ㅂ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "뚝배기에 끓여요." },
  { word: "뻥튀기", targetPhonemes: ["ㅃ", "ㅇ", "ㅌ", "ㄱ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "뻥튀기를 먹어요.", soundEffect: "뻥" },
  { word: "쪽지", targetPhonemes: ["ㅉ", "ㄱ", "ㅈ"], difficulty: "medium", ageGroup: "4-5세", sampleSentence: "쪽지를 써요." },
  { word: "쑤시다", targetPhonemes: ["ㅆ", "ㅅ", "ㄷ"], difficulty: "hard", ageGroup: "4-5세", sampleSentence: "이쑤시개로 쑤셔요." },
  { word: "뜨개질", targetPhonemes: ["ㄸ", "ㄱ", "ㅈ", "ㄹ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "뜨개질을 해요." },
  { word: "꿰매다", targetPhonemes: ["ㄲ", "ㄴ", "ㅁ", "ㄷ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "꿰매요." },
  { word: "써레질", targetPhonemes: ["ㅆ", "ㄹ", "ㅈ", "ㄹ"], difficulty: "hard", ageGroup: "5-6세", sampleSentence: "써레질을 해요." },
  { word: "뜯다", targetPhonemes: ["ㄸ", "ㄷ", "ㄷ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "뜯어요." },
  { word: "쫓다", targetPhonemes: ["ㅉ", "ㅅ", "ㄷ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "쫓아요." },
  { word: "찢다", targetPhonemes: ["ㅉ", "ㄷ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "찢어요." },
  { word: "깎다", targetPhonemes: ["ㄲ", "ㄱ", "ㄷ"], difficulty: "medium", ageGroup: "3-4세", sampleSentence: "깎아요." },
];
